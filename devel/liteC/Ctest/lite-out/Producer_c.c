...
any __or1,__or2,__or3,__or4,__or5,__or6,__or7,__or8,__or9,__or10,__or11,__or12,__or13,__or14,__or15,__or16,__or17,__or18,__or19,__or20,__or21,__or22,__or23,__or24,__or25,__or26,__or27,__or28;
...
// create _dispatcher.c & .h
        ...
        var resultLines = __call(getResult_,PROP(outCode_,PROP(lexer_,Producer_c_dispatcherModule)),0,NULL); //get .c file contents
        ...
        resultLines = __call(getResult_,PROP(outCode_,PROP(lexer_,Producer_c_dispatcherModule)),1,(any_arr){any_number(1)}); //get .h file contents
        //if resultLines.length
        if (_length(resultLines))  {
            //Environment.externalCacheSave '#{dispatcherModule.fileInfo.outFilename.slice(0,-1)}h',resultLines
            Environment_externalCacheSave(undefined,2,(any_arr){_concatAny(2,(any_arr){__call(slice_,PROP(outFilename_,PROP(fileInfo_,Producer_c_dispatcherModule)),2,(any_arr){any_number(0), any_number(-1)}), any_str("h")}), resultLines});
        };
    ...
    any Producer_c_normalizeDefine(DEFAULT_ARGUMENTS){
        ...
        int64_t _end8=_length(name);
        for(int64_t n=0; n<=_end8; n++) {
...
, Producer_c_NL, Producer_c_NL, any_str("enum _THINGS { //a symbol for each distinct property name"), Producer_c_NL});
        ...
        {NameValuePair_ptr __nvp=NULL; //name:value pair
        int64_t __len=MAPSIZE(_list60); //how many pairs
        var name=undefined; //key
        var value=undefined; //value
        for(int64_t __inx=0 ; __inx < __len ; __inx++ ){
            __nvp = MAPITEM( __inx,_list60);
            name= __nvp->name;
            value= __nvp->value;
...
// declared and the C compiler shows errors everywhere
        ...
        {NameValuePair_ptr __nvp=NULL; //name:value pair
        int64_t __len=MAPSIZE(_list61); //how many pairs
        var moduleNode=undefined; //value
        for(int64_t __inx=0 ; __inx < __len ; __inx++ ){
            __nvp = MAPITEM( __inx,_list61);
            ...
            METHOD(out_,this)(this,2,(any_arr){_concatAny(3,(any_arr){any_str("#include \""), hFile, any_str("\"")}), Producer_c_NL});
...
// process methods appended to core classes, by calling LiteC_registerShim
        ...
        for(int methodDeclaration__inx=0 ; methodDeclaration__inx<_list62.value.arr->length ; methodDeclaration__inx++){methodDeclaration=ITEM(methodDeclaration__inx,_list62);
                ...
                METHOD(out_,this)(this,8,(any_arr){any_str("    LiteC_registerShim("), PROP(varRef_,appendToDeclaration), _concatAny(3,(any_arr){any_str(","), PROP(name_,methodDeclaration), any_str("_,")}), PROP(varRef_,appendToDeclaration), any_str("_"), PROP(name_,methodDeclaration), any_str(");"), Producer_c_NL});
...
// call main module __init
        ...
        METHOD(out_,this)(this,4,(any_arr){any_str("\n\n    "), PROP(base_,PROP(fileInfo_,PROP(main_,project))), any_str("__moduleInit();"), Producer_c_NL});

        //.out '}',NL, {COMMENT: 'end main'},NL
        METHOD(out_,this)(this,4,(any_arr){any_str("}"), Producer_c_NL, new(Map,1,(any_arr){
...
, Producer_c_NL, _concatAny(3,(any_arr){any_str("#ifndef "), Producer_c_normalizeDefine(undefined,1,(any_arr){PROP(outRelFilename_,PROP(fileInfo_,this))}), any_str("_H")}), Producer_c_NL, _concatAny(3,(any_arr){any_str("#define "), Producer_c_normalizeDefine(undefined,1,(any_arr){PROP(outRelFilename_,PROP(fileInfo_,this))}), any_str("_H")}), Producer_c_NL, Producer_c_NL});
        ...
        METHOD(out_,this)(this,2,(any_arr){_concatAny(3,(any_arr){any_str("#include \""), Environment_relativeFrom(undefined,2,(any_arr){thisBase, dispatcherFull}), any_str("\"")}), Producer_c_NL});
...
, _concatAny(3,(any_arr){any_str("#include \""), prefix, any_str(".h\"")}), Producer_c_NL, Producer_c_NL, any_str("//-------------------------"), Producer_c_NL, any_str("//Module "), prefix, _anyToBool(PROP(isInterface_,PROP(fileInfo_,this))) ? any_str(" - INTERFACE") : any_EMPTY_STR, Producer_c_NL, any_str("//-------------------------"), Producer_c_NL});
        ...
        var insertPos = any_number(_length(PROP(lines_,PROP(outCode_,PROP(lexer_,this)))));
...
// insert at .c file start, helper tempvars for 'or' expressions short-circuit evaluation
        ...
        if (_anyToBool(PROP(orTempVarCount_,PROP(outCode_,PROP(lexer_,this)))))  {
            //.lexer.outCode.lines[insertPos++] = "//helper tempvars for 'or' expressions short-circuit evaluation"
            ITEM(insertPos.value.number++,PROP(lines_,PROP(outCode_,PROP(lexer_,this)))) = any_str("//helper tempvars for 'or' expressions short-circuit evaluation");
            //var list = "any __or1"
            var list = any_str("any __or1");
            //for n=2 to .lexer.outCode.orTempVarCount
            int64_t _end9=_anyToNumber(PROP(orTempVarCount_,PROP(outCode_,PROP(lexer_,this))));
            for(int64_t n=2; n<=_end9; n++) {
                //list &= ",__or#{n}"
                list=_concatAny(2,(any_arr){list,_concatAny(2,(any_arr){any_str(",__or"), any_number(n)})});
            };// end for n
            //list &=";"
            list=_concatAny(2,(any_arr){list,any_str(";")});
            //.lexer.outCode.lines[insertPos] = list
            ITEM(_anyToNumber(insertPos),PROP(lines_,PROP(outCode_,PROP(lexer_,this)))) = list;
        };
...
//#### method produceCallNamespaceInit()
     any Grammar_NamespaceDeclaration_produceCallNamespaceInit(DEFAULT_ARGUMENTS){
        ...
        METHOD(out_,this)(this,4,(any_arr){any_str("    "), METHOD(makeName_,this)(this,0,NULL), any_str("__namespaceInit();"), Producer_c_NL});
     return undefined;
     }
...
//#### method produceHeader
     any Grammar_NamespaceDeclaration_produceHeader(DEFAULT_ARGUMENTS){
        ...
        //var prefix= .makeName()
        var prefix = METHOD(makeName_,this)(this,0,NULL);
        ...
        for(int index=0 ; index<_list68.value.arr->length ; index++){item=ITEM(index,_list68);
            ...
            if (_instanceof(PROP(specific_,item),Grammar_ConstructorDeclaration))  {
                ...
                if (_anyToBool(hasConstructor))  {// # what? more than one?
                    ...
                    METHOD(throwError_,this)(this,1,(any_arr){_concatAny(2,(any_arr){any_str("Two constructors declared for class "), c})});
                };
                //hasConstructor = true
                hasConstructor = true;
            };
...
// default constructor
        ...
        if (!(_anyToBool(hasConstructor)) && !(_anyToBool(PROP(isInterface_,PROP(fileInfo_,METHOD(getParent_,this)(this,1,(any_arr){Grammar_Module}))))))  {
...
, Producer_c_NL, any_str("    "), PROP(varRefSuper_,this), any_str("__init(this,argc,arguments);"), Producer_c_NL});
            ...
            __call(producePropertiesInitialValueAssignments_,PROP(body_,this),1,(any_arr){_concatAny(3,(any_arr){any_str("(("), c, any_str("_ptr)this.value.ptr)->")})});
          ...
          // where nameDecl.name not in ['constructor','length','prototype']
            if(!(__in(PROP(name_,nameDecl),3,(any_arr){any_str("constructor"), any_str("length"), any_str("prototype")}))){
                ...
                if (_anyToBool(PROP(isMethod_,nameDecl)))  {
                    ...
                    METHOD(out_,this)(this,2,(any_arr){_concatAny(7,(any_arr){any_str("  { "), Producer_c_makeSymbolName(undefined,1,(any_arr){PROP(name_,nameDecl)}), any_str(", "), c, any_str("_"), PROP(name_,nameDecl), any_str(" },")}), Producer_c_NL});
                }
                //else
...
// out all properties of a class, including those of the super's-chain
        ...
        if (!_anyToBool(prt)) {METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(3,(any_arr){any_str("class "), PROP(name_,this), any_str(" has no prototype")})});};
...
// add comment lines, in the same position as the source
        ...
        METHOD(outPrevLinesComments_,this)(this,0,NULL);
...
// To ease reading of compiled code, add original Lite line as comment
        ...
        if (_anyToBool(PROP(comments_,PROP(options_,PROP(lexer_,this)))))  { // and .lexer.outCode.lastOriginalCodeComment<.lineInx
            ...
            if (_anyToBool((_anyToBool(__or3=(_anyToBool(__or4=(_anyToBool(__or5=(_anyToBool(__or6=any_number(_hasProperty(PROP(specific_,this),any_str("body"))))? __or6 : any_number(_instanceof(PROP(specific_,this),Grammar_IfStatement))))? __or5 : any_number(_instanceof(PROP(specific_,this),Grammar_WithStatement))))? __or4 : any_number(_instanceof(PROP(specific_,this),Grammar_ForStatement))))? __or3 : any_number(_instanceof(PROP(specific_,this),Grammar_SwitchStatement)))))  {
                    //commentTo =  .sourceLineNum
                    commentTo = PROP(sourceLineNum_,this);
            };

            //.outSourceLinesAsComment .sourceLineNum, commentTo
            METHOD(outSourceLinesAsComment_,this)(this,2,(any_arr){PROP(sourceLineNum_,this), commentTo});
...
// e.g.: DO NOT: `stra+": "+strb`   DO: `"#{stra}: #{strb}"`
        ...
        if (__is(oper,any_str("+")))  {
            ...
            if (_anyToBool((_anyToBool(__or12=any_number(_anyToBool(lresultNameDecl) && _anyToBool(METHOD(isInstanceof_,lresultNameDecl)(lresultNameDecl,1,(any_arr){any_str("String")}))))? __or12 : any_number(_anyToBool(rresultNameDecl) && _anyToBool(METHOD(isInstanceof_,rresultNameDecl)(rresultNameDecl,1,(any_arr){any_str("String")}))))))  {
                            //"""
...
, any_str("})"), append, toAnyPost});
            ...
            var orTmp = _concatAny(2,(any_arr){any_str("__or"), PROP(orTempVarCount_,PROP(outCode_,PROP(lexer_,this)))});
            ...
            METHOD(out_,this)(this,5,(any_arr){_concatAny(3,(any_arr){any_str("(_anyToBool("), orTmp, any_str("=")}), PROP(left_,this), _concatAny(3,(any_arr){any_str(")? "), orTmp, any_str(" : ")}), PROP(right_,this), any_str(")")});
            ...
            METHOD(out_,this)(this,5,(any_arr){any_str("_concatAny(2,(any_arr){"), PROP(left_,this), any_str(","), PROP(right_,this), any_str("})")});
...
// Start with main variable name, to check property names
        ...
        if (!_anyToBool(actualVar)) {METHOD(throwError_,this)(this,1,(any_arr){_concatAny(3,(any_arr){any_str("var '"), PROP(name_,this), any_str("' not found in scope")})});};
...
// else, for FunctionAccess
            //else if ac.constructor is Grammar.FunctionAccess
                ...
                if (inx > 1 && !__is(any_class(ITEM(inx - 1,PROP(accessors_,this)).class),Grammar_PropertyAccess))  {
                    ...
                    METHOD(throwError_,this)(this,1,(any_arr){_concatAny(3,(any_arr){any_str("'"), partial, any_str(".call' or '.apply' must be used to call a function pointer stored in a variable")})});
                };
                ...
                //else
                    ...
                    //else
                        ...
                        if (_anyToBool(false))  { //functionAccess.args and functionAccess.args.length<=4
                            ...
                            METHOD(unshift_,fnNameArray)(fnNameArray,1,(any_arr){_concatAny(3,(any_arr){any_str("CALL"), any_number(_length(PROP(args_,functionAccess))), any_str("(")})});
...
// and next property access should be on defined members of the type
      ...
      any Grammar_VariableRef_addArguments(DEFAULT_ARGUMENTS){
        ...
        if (_anyToBool(args) && _length(args))  {
            ...
            METHOD(push_,callParams)(callParams,3,(any_arr){_concatAny(2,(any_arr){any_number(_length(args)), any_str(",(any_arr){")}), new(Map,1,(any_arr){
            _newPair("CSL",args)
            })
, any_str("}")});
        }
      ...
      any Grammar_AssignmentStatement_produce(DEFAULT_ARGUMENTS){
        ...
        if (__is(_switch9,any_str("+="))||__is(_switch9,any_str("-="))||__is(_switch9,any_str("*="))||__is(_switch9,any_str("/="))){
                ...
                if (__is(oper,any_str("+=")))  {
                    ...
                    if (_anyToBool(rresultNameDecl) && _anyToBool(METHOD(isInstanceof_,rresultNameDecl)(rresultNameDecl,1,(any_arr){any_str("String")})))  {
                                //"""
        ...
        else if (__is(_switch9,any_str("&="))){
                //.rvalue.produceType = 'any'
                PROP(produceType_,PROP(rvalue_,this)) = any_str("any");
                //.out .lvalue, '=', "_concatAny(2,(any_arr){",.lvalue,',',.rvalue,'})'
                METHOD(out_,this)(this,7,(any_arr){PROP(lvalue_,this), any_str("="), any_str("_concatAny(2,(any_arr){"), PROP(lvalue_,this), any_str(","), PROP(rvalue_,this), any_str("})")});
      ...
      any Names_Declaration_addToAllProperties(DEFAULT_ARGUMENTS){
        ...
        if (CALL1(indexOf_,Producer_c_coreSupportedProps,name).value.number==-1 && !(_anyToBool(METHOD(has_,Producer_c_allPropertyNames)(Producer_c_allPropertyNames,1,(any_arr){name}))))  {
            ...
            if (_anyToBool(METHOD(has_,Producer_c_allMethodNames)(Producer_c_allMethodNames,1,(any_arr){name})))  {
                ...
                METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(3,(any_arr){any_str("Ambiguity: A method named '"), name, any_str("' is already defined. Cannot reuse the symbol for a property")})});
                //allMethodNames.get(name).sayErr "declaration of method '#{name}'"
                __call(sayErr_,METHOD(get_,Producer_c_allMethodNames)(Producer_c_allMethodNames,1,(any_arr){name}),1,(any_arr){_concatAny(3,(any_arr){any_str("declaration of method '"), name, any_str("'")})});
            }
            //else if name in coreSupportedMethods
                ...
                METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(3,(any_arr){any_str("'"), name, any_str("' is declared in as a core method. Cannot use the symbol for a property")})});
            }
            //else
...
// variable name and optionally assign a value
      ...
      any Grammar_VariableDecl_produce(DEFAULT_ARGUMENTS){
        ...
        METHOD(out_,this)(this,3,(any_arr){PROP(name_,this), any_str(" = "), (_anyToBool(__or18=PROP(assignedValue_,this))? __or18 : any_str("undefined"))});
      return undefined;
      }
...
//### Append to class Grammar.SingleLineBody ###
      ...
      any Grammar_SingleLineBody_produce(DEFAULT_ARGUMENTS){
        ...
        METHOD(out_,this)(this,2,(any_arr){new(Map,2,(any_arr){
        _newPair("CSL",bare), 
...
//### Append to class Grammar.IfStatement ###
      ...
      any Grammar_IfStatement_produce(DEFAULT_ARGUMENTS){
        ...
        if (_anyToBool(PROP(elseStatement_,this)))  {
            ...
            METHOD(outPrevLinesComments_,this)(this,1,(any_arr){any_number(_anyToNumber(PROP(lineInx_,PROP(elseStatement_,this))) - 1)});
...
// Create a default index var name if none was provided
        ...
        if (_anyToBool((_anyToBool(__or19=(_anyToBool(__or20=any_number(_anyToNumber(PROP(operandCount_,PROP(iterable_,this))) > 1))? __or20 : PROP(hasSideEffects_,PROP(name_,PROP(root_,PROP(iterable_,this))))))? __or19 : any_number(_instanceof(PROP(name_,PROP(root_,PROP(iterable_,this))),Grammar_Literal)))))  {
            //listName = uniqueName
            listName = uniqueName;
...
// create a var holding object property count
        ...
        METHOD(out_,this)(this,4,(any_arr){any_str("len_t __propCount="), listName, any_str(".class->instanceSize / sizeof(any);"), Producer_c_NL});
...
// Create a default index var name if none was provided
        ...
        if (_anyToBool(PROP(indexVar_,this)))  {
            ...
            startValue = (_anyToBool(__or21=PROP(assignedValue_,PROP(indexVar_,this)))? __or21 : any_str("0"));
        }
        //else
...
// For loops "to/down to" evaluate end expresion only once
        ...
        METHOD(out_,this)(this,5,(any_arr){any_str("for(int64_t "), PROP(name_,PROP(indexVar_,this)), any_str("="), (_anyToBool(__or22=PROP(assignedValue_,PROP(indexVar_,this)))? __or22 : any_str("0")), any_str("; ")});
...
// if no increment specified, the default is indexVar++/--
        ...
        METHOD(out_,this)(this,7,(any_arr){_anyToBool(PROP(increment_,this)) ? PROP(specific_,PROP(increment_,this)) : new(Array,2,(any_arr){PROP(name_,PROP(indexVar_,this)), __is(PROP(conditionPrefix_,this),any_str("down")) ? any_str("--") : any_str("++")}), any_str(") "), any_str("{"), PROP(body_,this), any_str("};"), new(Map,1,(any_arr){
...
// `ForWhereFilter: [where Expression]`
      ...
      any Grammar_ForWhereFilter_produce(DEFAULT_ARGUMENTS){
        ...
        METHOD(outLineAsComment_,this)(this,1,(any_arr){PROP(lineInx_,this)});
...
// validate usage inside a for/while
        ...
        while(TRUE){
            ...
            if (__is(PROP(control_,this),any_str("break")) && _instanceof(nodeASTBase,Grammar_SwitchCase))  {
                ...
                METHOD(sayErr_,this)(this,1,(any_arr){any_str("cannot use \"break\" from inside a \"switch\" statement for \"historic\" reasons")});
            }
            ...
            else if (_anyToBool((_anyToBool(__or23=any_number(_instanceof(nodeASTBase,Grammar_ForStatement)))? __or23 : any_number(_instanceof(nodeASTBase,Grammar_DoLoop)))))  {
...
// On js we just pass this through, on C we create the array on the fly
      ...
      any Grammar_ArrayLiteral_produce(DEFAULT_ARGUMENTS){
        ...
        if (_anyToBool((_anyToBool(__or24=any_number(!_anyToBool(PROP(items_,this))))? __or24 : any_number(__is(any_number(_length(PROP(items_,this))),any_number(0))))))  {
            //.out "0,NULL"
...
// Initialize (non-undefined) properties with assigned values.
        ...
        __call(producePropertiesInitialValueAssignments_,PROP(body_,METHOD(getParent_,this)(this,1,(any_arr){Grammar_ClassDeclaration})),1,(any_arr){_concatAny(2,(any_arr){c, any_str("_")})});
...
, any_str(";"), Producer_c_NL, METHOD(join_,namedParams)(namedParams,1,(any_arr){any_str("=")}), any_str("=undefined;"), Producer_c_NL, any_str("switch(argc){"), Producer_c_NL});
                    ...
                    for(int64_t inx=_length(namedParams) - 1; inx >= 0; inx--) {
                        ...
                        __call(out_,PROP(body_,this),2,(any_arr){_concatAny(7,(any_arr){any_str("  case "), any_number(inx + 1), any_str(":"), ITEM(inx,namedParams), any_str("=arguments["), any_number(inx), any_str("];")}), Producer_c_NL});
                    };// end for inx
...
// `print` is an alias for console.log
      ...
      any Grammar_PrintStatement_produce(DEFAULT_ARGUMENTS){
        ...
        if (_length(PROP(args_,this)))  {
            ...
            METHOD(out_,this)(this,3,(any_arr){_concatAny(3,(any_arr){any_str("print("), any_number(_length(PROP(args_,this))), any_str(",(any_arr){")}), new(Map,1,(any_arr){
...
// Out as comments
      ...
      any Grammar_DeclareStatement_produce(DEFAULT_ARGUMENTS){
        ...
        METHOD(outLinesAsComment_,this)(this,2,(any_arr){PROP(lineInx_,this), _anyToBool(PROP(names_,this)) ? METHOD(lastLineInxOf_,this)(this,1,(any_arr){PROP(names_,this)}) : PROP(lineInx_,this)});
        //.skipSemiColon = true
        PROP(skipSemiColon_,this) = true;
      return undefined;
      }
        ...
        any Names_Declaration_addToAllMethodNames(DEFAULT_ARGUMENTS){
            ...
            if (CALL1(indexOf_,Producer_c_coreSupportedMethods,methodName).value.number==-1 && !(_anyToBool(METHOD(has_,Producer_c_allMethodNames)(Producer_c_allMethodNames,1,(any_arr){methodName}))))  {
                ...
                if (_anyToBool(METHOD(has_,Producer_c_allPropertyNames)(Producer_c_allPropertyNames,1,(any_arr){methodName})))  {
                    ...
                    METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(3,(any_arr){any_str("Ambiguity: A property '"), methodName, any_str("' is already defined. Cannot reuse the symbol for a method.")})});
                    //allPropertyNames.get(methodName).sayErr "Definition of property '#{methodName}'."
                    __call(sayErr_,METHOD(get_,Producer_c_allPropertyNames)(Producer_c_allPropertyNames,1,(any_arr){methodName}),1,(any_arr){_concatAny(3,(any_arr){any_str("Definition of property '"), methodName, any_str("'.")})});
                }
                //else if methodName in coreSupportedProps
                    ...
                    METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(3,(any_arr){any_str("Ambiguity: A property '"), methodName, any_str("' is defined in core. Cannot reuse the symbol for a method.")})});
                }
                //else
...
// we produce as chained if-else, using == to switchValue
        ...
        if (_anyToBool(PROP(varRef_,this)))  {
            ...
            METHOD(out_,this)(this,6,(any_arr){any_str("any "), switchVar, any_str("="), PROP(varRef_,this), any_str(";"), Producer_c_NL});
            ...
            for(int index=0 ; index<_list87.value.arr->length ; index++){switchCase=ITEM(index,_list87);
                ...
                METHOD(outLineAsComment_,this)(this,1,(any_arr){PROP(lineInx_,switchCase)});
                ...
                //.out 
                    ...
                    //NL
                    //'}'
                METHOD(out_,this)(this,7,(any_arr){index > 0 ? any_str("else ") : any_EMPTY_STR, any_str("if ("), new(Map,4,(any_arr){
...
// defaul case
        ...
        if (_anyToBool(PROP(defaultBody_,this))) {METHOD(out_,this)(this,4,(any_arr){Producer_c_NL, any_str("else {"), PROP(defaultBody_,this), any_str("}")});};
      return undefined;
      }
...
//### Append to class Grammar.SwitchCase ###
      ...
      any Grammar_SwitchCase_produce(DEFAULT_ARGUMENTS){
        ...
        METHOD(out_,this)(this,1,(any_arr){new(Map,4,(any_arr){
        ...
        METHOD(out_,this)(this,1,(any_arr){PROP(body_,this)});
        //.body.out 'break;',NL
        __call(out_,PROP(body_,this),2,(any_arr){any_str("break;"), Producer_c_NL});
      return undefined;
      }
...
// if we have a varRef, is a case over a value
        ...
        if (_anyToBool(PROP(varRef_,this)))  {
            ...
            METHOD(out_,this)(this,4,(any_arr){any_str("(function("), caseVar, any_str("){"), Producer_c_NL});
            ...
            for(int caseWhenSection__inx=0 ; caseWhenSection__inx<_list90.value.arr->length ; caseWhenSection__inx++){caseWhenSection=ITEM(caseWhenSection__inx,_list90);
                ...
                METHOD(out_,caseWhenSection)(caseWhenSection,6,(any_arr){any_str("if("), new(Map,4,(any_arr){
...
, any_str(") return "), PROP(resultExpression_,caseWhenSection), any_str(";"), Producer_c_NL});
            ...
            if (_anyToBool(PROP(elseExpression_,this))) {METHOD(out_,this)(this,4,(any_arr){any_str("    return "), PROP(elseExpression_,this), any_str(";"), Producer_c_NL});};
            //.out '        }(',.varRef,'))'
            METHOD(out_,this)(this,3,(any_arr){any_str("        }("), PROP(varRef_,this), any_str("))")});
        }
...
// else, it's a var-less case. we code it as chained ternary operators
        //else
          ...
          for(int caseWhenSection__inx=0 ; caseWhenSection__inx<_list91.value.arr->length ; caseWhenSection__inx++){caseWhenSection=ITEM(caseWhenSection__inx,_list91);
              ...
              METHOD(outLineAsComment_,this)(this,1,(any_arr){PROP(lineInx_,caseWhenSection)});
              ...
              METHOD(out_,caseWhenSection)(caseWhenSection,6,(any_arr){any_str("("), PROP(booleanExpression_,caseWhenSection), any_str(") ? ("), PROP(resultExpression_,caseWhenSection), any_str(") :"), Producer_c_NL});
          }};// end for each in PROP(cases_,this)

          //.out '/* else */ ',.elseExpression or 'undefined'
          METHOD(out_,this)(this,2,(any_arr){any_str("/* else */ "), (_anyToBool(__or26=PROP(elseExpression_,this))? __or26 : any_str("undefined"))});
        };
      return undefined;
      }
...
, any_str(" ]")});
    ...
    any Producer_c_operTranslate(DEFAULT_ARGUMENTS){
      ...
      return (_anyToBool(__or28=METHOD(get_,Producer_c_OPER_TRANSLATION_map)(Producer_c_OPER_TRANSLATION_map,1,(any_arr){name}))? __or28 : name);
    return undefined;
    }
...
;
    Producer_c_NL = any_str("\n");
    Producer_c_OPER_TRANSLATION_map = new(Map,15,(any_arr){
      _newPair("no",any_str("!")), 
