...
//Generate unique numbers, starting at 1
        ...
        METHOD(set_,UniqueID_uniqueIds)(UniqueID_uniqueIds,2,(any_arr){prefix, any_number(_anyToNumber(value) - 1)});
    return undefined;
    }
...
//Generate unique numbers, starting at 1
        ...
        var id = (_anyToBool(__or1=METHOD(get_,UniqueID_uniqueIds)(UniqueID_uniqueIds,1,(any_arr){prefix}))? __or1 : any_number(0));
        //id += 1
        id.value.number += 1;
        //uniqueIds.set prefix, id
        METHOD(set_,UniqueID_uniqueIds)(UniqueID_uniqueIds,2,(any_arr){prefix, id});
        //return id
        return id;
    return undefined;
    }
