        ...
        //else
            ...
            if (!(_anyToBool(found)))  {
                //logger.throwControlled """
                        ...
                        //"""
                logger_throwControlled(undefined,1,(any_arr){_concatAny(6,PROP(relFilename_,importingModuleFileInfo), any_str(": Module not found: "), PROP(name_,PROP(importInfo_,this)), any_str("\nSearched as:\n"), METHOD(join_,search)(search,1,(any_arr){any_str("\n")}), any_str("\n   with extensions (.lite.md|.md|.interface.md|.js)"))});
            };
        };
        //end if
...
//### export Class ImportParameterInfo
    ...
    any Environment_dirName(DEFAULT_ARGUMENTS){
        // define named params
