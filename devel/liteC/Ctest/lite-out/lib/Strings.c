...
//.capitalized
        ...
        any String_capitalized(DEFAULT_ARGUMENTS){
           ...
           if (_anyToBool(this)) {return _concatAny(2,__call(toUpperCase_,METHOD(charAt_,this)(this,1,(any_arr){any_number(0)}),0,NULL), METHOD(slice_,this)(this,1,(any_arr){any_number(1)}));};
        return undefined;
        }
...
//.quoted(quotechar)
        ...
        any String_quoted(DEFAULT_ARGUMENTS){
            ...
            return _concatAny(3,quoteChar, this, quoteChar);
        return undefined;
        }
