...
any __or1,__or2,__or3,__or4,__or5,__or6,__or7;
        ...
        for(int nameDecl__inx=0 ; nameDecl__inx<_list38.value.arr->length ; nameDecl__inx++){nameDecl=ITEM(nameDecl__inx,_list38);
            ...
            if (_anyToBool(PROP(isForward_,nameDecl)) && !(_anyToBool(PROP(isDummy_,nameDecl))))  {
                ...
                if (_anyToBool(container))  {
                  ...
                  if (_anyToBool(PROP(varRef_,container))) {logger_warning(undefined,1,(any_arr){_concatAny(6,(any_arr){METHOD(positionText_,container)(container,0,NULL), any_str(" more info: '"), PROP(name_,nameDecl), any_str("' of '"), __call(toString_,PROP(varRef_,container),0,NULL), any_str("'")})});};
                };
            };
        }};// end for each in Names_allNameDeclarations
...
// Process the global scope declarations interface file: GlobalScopeJS.interface.md
        ...
        var globalInterfaceFile = _concatAny(3,(any_arr){process_cwd(undefined,0,NULL), any_str("/lib/GlobalScope"), __call(toUpperCase_,PROP(target_,PROP(options_,Validate_project)),0,NULL)});
...
// returns 'true' if converted, 'false' if it has to be tried later
        ...
        //else
            ...
            METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(9,(any_arr){any_str("INTERNAL ERROR: convertType UNRECOGNIZED type of:'"), _typeof(typeRef), any_str("' on "), internalName, any_str(": '"), typeRef, any_str("' ["), PROP(name_,any_class(typeRef.class)), any_str("]")})});
            //return
            return undefined;
        };
        ...
        //else
            ...
            if (_anyToBool(options) && _anyToBool(PROP(informError_,options))) {METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(3,(any_arr){any_str("Undeclared type: '"), METHOD(toString_,typeRef)(typeRef,0,NULL), any_str("'")})});};
        };
        //end if
...
// or inform error. We need this AST node, to correctly report error.
        ...
        //else #not found
          ...
          if (_anyToBool(PROP(informError_,options)))  {
                ...
                logger_warning(undefined,1,(any_arr){_concatAny(5,(any_arr){METHOD(positionText_,this)(this,0,NULL), any_str(". No member named '"), name, any_str("' on "), METHOD(info_,nameDecl)(nameDecl,0,NULL)})});
          };
...
// if it is not found,check options: a) inform error. b) declare foward.
        //else
            ...
            if (_anyToBool(options) && _anyToBool(PROP(informError_,options)))  {
                ...
                METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(3,(any_arr){any_str("UNDECLARED NAME: '"), name, any_str("'")})});
            };
     ...
     any ASTBase_addToSpecificScope(DEFAULT_ARGUMENTS){
        ...
        if (_anyToBool((found=METHOD(findInScope_,this)(this,1,(any_arr){name}))))  {
            ...
            //else 
              ...
              METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(3,(any_arr){any_str("DUPLICATED name in scope: '"), name, any_str("'")})});
...
// initializes an empty scope in this node
        ...
        if (!_anyToBool(PROP(scope_,this)))  {
          ...
          PROP(scope_,this) = METHOD(declareName_,this)(this,2,(any_arr){_concatAny(3,(any_arr){any_str("["), PROP(name_,any_class(this.class)), any_str(" Scope]")}), options});
          //.scope.isScope = true
        ...
        if (_instanceof(parent,Grammar_AppendToDeclaration))  {
            ...
            if (!(_anyToBool((ownerDecl=__call(tryGetReference_,PROP(varRef_,parent),0,NULL)))))  {
                ...
                if (_anyToBool(informError))  {
                    ...
                    METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(3,(any_arr){any_str("Append to: '"), PROP(varRef_,parent), any_str("'. Reference is not fully declared")})});
                };
...
// check if owner is class (namespace) or class.prototype (class)
        ...
        //else
            ...
            if (!(_anyToBool((ownerDeclProto=METHOD(findOwnMember_,ownerDecl)(ownerDecl,1,(any_arr){any_str("prototype")})))))  {
                ...
                if (_anyToBool(informError)) {METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(3,(any_arr){any_str("Class '"), ownerDecl, any_str("' has no .prototype")})});};
                //return
                return undefined;
            };
...
// and set this new nameDecl as function's **return type**
          ...
          var composedName = _concatAny(2,(any_arr){__call(toString_,PROP(itemType_,this),0,NULL), any_str(" Array")});
...
// get referenced class/namespace
      ...
      if (!(_anyToBool((ownerDecl=__call(tryGetReference_,PROP(varRef_,this),0,NULL)))))  {
          ...
          METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(3,(any_arr){any_str("Append to: '"), PROP(varRef_,this), any_str("'. Reference is not fully declared")})});
          //return //if no ownerDecl found
          return undefined; //if no ownerDecl found
      };

      //var prt=ownerDecl.findOwnMember('prototype')
      var prt = METHOD(findOwnMember_,ownerDecl)(ownerDecl,1,(any_arr){any_str("prototype")});
      ...
      if (__is(PROP(target_,PROP(options_,Validate_project)),any_str("c")))  {
          ...
          if (_anyToBool(PROP(toNamespace_,this)) && _anyToBool(prt))  {
              ...
              METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(3,(any_arr){any_str("Append to: '"), PROP(varRef_,this), any_str("'. For C production, canot add to class as namespace.")})});
          };
      };
...
// so we can later validate `.x` in `this.x = 7`
                  ...
                  METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(3,(any_arr){any_str("unexpected \""), PROP(name_,any_class(PROP(specific_,item).class)), any_str("\" inside Append-to Declaration")})});
          };
...
// Check for duplicate class properties in the super class
        ...
        if (_anyToBool((superPrt=METHOD(findOwnMember_,superClassNameDecl)(superClassNameDecl,1,(any_arr){any_str("prototype")}))))  {
            ...
            if (_anyToBool((originalNameDecl=METHOD(findOwnMember_,superPrt)(superPrt,1,(any_arr){PROP(name_,this)}))))  {
                ...
                METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(5,(any_arr){any_str("Duplicated property. super class ["), superClassNameDecl, any_str("] already has a property '"), this, any_str("'")})});
...
// get referenced super class
      ...
      if (_anyToBool(PROP(varRefSuper_,this)))  {
          ...
          if (!(_anyToBool((superClassNameDecl=__call(tryGetReference_,PROP(varRefSuper_,this),0,NULL)))))  {
              ...
              METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(5,(any_arr){any_str("class "), PROP(name_,this), any_str(" extends '"), PROP(varRefSuper_,this), any_str("'. Reference is not fully declared")})});
...
// ForEachInArray: check if the iterable has a .length property.
        ...
        //else if no iterableType.findMember('length')
            ...
            METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(5,(any_arr){any_str("ForEachInArray: no .length property declared in '"), PROP(iterable_,this), any_str("' type:'"), METHOD(toString_,iterableType)(iterableType,0,NULL), any_str("'")})});
            ...
            //else if ac instanceof Grammar.FunctionAccess
                ...
                if (_anyToBool((prt=METHOD(findOwnMember_,actualVar)(actualVar,1,(any_arr){any_str("**proto**")}))))  {
                    ...
                    if (!__is(PROP(name_,prt),any_str("Function")))  {
                        ...
                        METHOD(warn_,this)(this,1,(any_arr){_concatAny(5,(any_arr){any_str("function call. '"), actualVar, any_str("' is class '"), PROP(name_,prt), any_str("', not 'Function'")})});
                    };
                };
...
// check if we can continue on the chain
        ...
        if (!_anyToBool(actualVar) && _anyToBool(PROP(informError_,options)))  {
            ...
            METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(5,(any_arr){any_str("'"), this, any_str("'. Reference can not be analyzed further than '"), partial, any_str("'")})});
        };
...
// Assign type if it was declared
      ...
      if (_anyToBool(toSet))  {// #create type on the fly
          ...
          if (_anyToBool(PROP(failures_,result))) {METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(3,(any_arr){any_str("can't find type '"), toSet, any_str("' in scope")})});};
      };
     return undefined;
     }
