...
${OBJECTDIR}/ScriptyC-core1.o: ScriptyC-core1.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ScriptyC-core1.o ScriptyC-core1.c
...
${OBJECTDIR}/newfile.o: newfile.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I/usr/include -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/newfile.o newfile.c
