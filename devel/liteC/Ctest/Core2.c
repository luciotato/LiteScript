...
// Core2
   ...
   // public class TestClass
       ...
       String TestClass__sliceJoin(TestClass this,int start, int endPos){
           ...
           if (start >= endPos) {return mkString("");};

           String result;
           // for n=start to endPos
           for(int n=start; n<=endPos; n++) {
               //result += this->myArr[n] + mkStr(" ");
           };// end for n
