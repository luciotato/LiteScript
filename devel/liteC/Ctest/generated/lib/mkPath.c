...
// =============
   ...
   any mkPath_toFile(DEFAULT_ARGUMENTS){// define named params
       var filename, mode;
...
// Create a path to a file
   ...
   any mkPath_create(DEFAULT_ARGUMENTS){// define named params
       var dirPath, mode;
...
// return into recursion, creating children subdirs in reverse order (of recursion)
   ...
   any mkPath_dirExists(DEFAULT_ARGUMENTS){// define named params
