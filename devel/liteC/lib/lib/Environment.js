//Compiled by LiteScript compiler v0.7.0, source: /home/ltato/LiteScript/devel/source-v0.8/lib/Environment.lite.md
...
// Module vars
   ...
   // constructor
    ...
    FileInfo.prototype.searchModule = function(importingModuleFileInfo){
...
// we search the module
       ...
       if (this.importInfo.createFile) {
           ...
           if (this.hasPath) {// #specific path indicated
               ...
               search = [path.join(importingModuleFileInfo.dir, this.importInfo.name), path.join(projectDir, '/lib', this.importInfo.name)];
...
// return true if 'name' is a built-in node module
       ...
       null; // if generating the compile-to-C compiler
   };
   // export
