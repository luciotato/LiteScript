//Compiled by LiteScript compiler v0.4.0, source: /home/ltato/LiteScript/devel/source-v0.5/Environment.lite.md
...
//we search the module
       ...
       if (!this.extension || this.extension === '.md') {
           ...
           var list__1=['.lite.md', '.md', '.interface.md', '.js'];
           for( var ext__inx=0,ext ; ext__inx<list__1.length ; ext__inx++){ext=list__1[ext__inx];
