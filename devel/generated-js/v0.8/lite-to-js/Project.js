//Generated by LiteScript compiler v0.8.7, source: Project.lite.md
// -----------
// Module Init
// -----------
//==============================
                    ...
                    if (this.options.generateSourceMap) {
                        ...
                        //Environment.externalCacheSave '#{moduleNode.fileInfo.outFilename}.map',
                                //moduleNode.lexer.outCode.sourceMap.generate(
                                              ...
                                              //)
                        Environment.externalCacheSave('' + moduleNode.fileInfo.outFilename + '.map', moduleNode.lexer.outCode.sourceMap.generate(moduleNode.fileInfo.base + moduleNode.fileInfo.outExtension, Environment.getDir(Environment.relativeFrom(moduleNode.fileInfo.outDir, moduleNode.fileInfo.sourcename)), [moduleNode.fileInfo.sourcename]));
                    };
                };
...
//2. each VariableDecl, from ImportStatements
     ...
     Project.prototype.produceModule = function(moduleNode){
        ...
        if (this.options.comments) {
            ...
            moduleNode.lexer.outCode.put("//Generated by LiteScript compiler v" + this.options.version + ", source: " + moduleNode.fileInfo.relFilename);
