        ...
        //else # directly inside a ClassDeclaration|NamespaceDeclaration
            ...
            if (!ownerDecl) {
                ...
                if (parent.hasAdjective('shim')) { // it was a shim class|namespace
                    ...
                    ownerDecl = this.findInScope(parent.name); //get pre-existent
                };
...
//### Append to class Grammar.ImportStatementItem ###
      ...
      Grammar.ImportStatementItem.prototype.declare = function(){// #pass 1: declare name choosen for imported(required) contents as a scope var
...
//Scope starts populated by 'this' and 'arguments'.
      ...
      if (!(isFunction)) {
          ...
          if (!((containerClassDeclaration=this.getParent(Grammar.ClassDeclaration)))) { //also append-to & NamespaceDeclaration
...
//#### Method declare() 
     Grammar.Oper.prototype.declare = function(){
        ...
        if (this.intoVar === '*r') {// # is a into-assignment operator with 'var' declaration
