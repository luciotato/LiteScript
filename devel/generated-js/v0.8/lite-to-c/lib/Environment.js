        ...
        //else
            ...
            //else
                ...
                //search = [ 
                    ...
                    //path.join(projectDir,'../lib',this.importInfo.name)
                    //path.join(projectDir,'../interfaces',this.importInfo.name)
                search = [path.join(importingModuleDir, this.importInfo.name), path.join(projectDir, '/lib', this.importInfo.name), path.join(projectDir, '/interfaces', this.importInfo.name), path.join(projectDir, '../lib', this.importInfo.name), path.join(projectDir, '../interfaces', this.importInfo.name)];
                    //]
...
//gets redirected to dir `ENV_C_global_import` or `../ENV_C_global_import`
                ...
                if (targetExt === 'c') {
                    ...
                    //search.unshift 
                        ...
                        //path.join(projectDir,'../ENV_C_global_import',this.importInfo.name)
                    search.unshift(path.join(projectDir, '/ENV_C_global_import', this.importInfo.name), path.join(projectDir, '../ENV_C_global_import', this.importInfo.name));
                };
                //end if
