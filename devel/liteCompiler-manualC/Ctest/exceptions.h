...
#define E4C_CATCH(ERRVAR) \
             ...
             for(var ERRVAR = e4c.err.object; e4c.frame[e4c.frames].uncaught!=0; e4c.frame[e4c.frames].uncaught=0)
...
extern void e4c_throw( const char * file, int line, var errObject);
