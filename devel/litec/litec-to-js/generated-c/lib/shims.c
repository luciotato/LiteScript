...
//### Append to class String
        ...
        any String_startsWith(DEFAULT_ARGUMENTS){
            ...
            return any_number(__is(METHOD(slice_,this)(this,2,(any_arr){
        any_number(0), 
        ...
        any String_endsWith(DEFAULT_ARGUMENTS){
            ...
            return any_number(__is(METHOD(slice_,this)(this,1,(any_arr){
        any_number(-_length(text))
}),text));
        return undefined;
        }
        ...
        any String_trimRight(DEFAULT_ARGUMENTS){
            ...
            do{
                //inx-- 
                inx.value.number--;
            } while (_anyToNumber(inx) >= 0 && __is(METHOD(charAt_,this)(this,1,(any_arr){
        inx
}),any_LTR(" ")));// end loop
            //loop while inx>=0 and this.charAt(inx) is ' '
            //return this.slice(0,inx+1) 
            return METHOD(slice_,this)(this,2,(any_arr){
        any_number(0), 
...
;
            ...
            while(_anyToNumber(inx) < _anyToNumber(len) && __is(METHOD(charAt_,this)(this,1,(any_arr){
        inx
}),any_LTR(" "))){
                //inx++
                inx.value.number++;
            ...
            return METHOD(slice_,this)(this,1,(any_arr){
        inx
});
        return undefined;
        }
//.capitalized
        ...
        any String_capitalized(DEFAULT_ARGUMENTS){
           ...
           if (_anyToBool(this)) {return _concatAny(2,
        (__call(toUpperCase_,METHOD(charAt_,this)(this,1,(any_arr){
        any_number(0)
}),0,NULL)), 
        (METHOD(slice_,this)(this,1,(any_arr){
        any_number(1)
}))
);};
        return undefined;
...
//.quoted(quotechar)
        ...
        any String_rpad(DEFAULT_ARGUMENTS){
            ...
            return METHOD(concat_,this)(this,1,(any_arr){
        String_spaces(undefined,1,(any_arr){
        any_number(_anyToNumber(howMany) - _length(this))
})
});
        return undefined;
        }
...
//capitalized is like: /^[A-Z]+[$_a-z0-9]+$/ ,but unicode aware.
        ...
        any_number(0)
                ...
                for(int64_t n=1; n < _length(text); n++){
                    ...
                    if (__is(METHOD(charAt_,text)(text,1,(any_arr){
        any_number(n)
...
//Note: text[start] MUST be the opener char
        ...
        any String_findMatchingPair(DEFAULT_ARGUMENTS){
            ...
            var 
        opener = METHOD(charAt_,text)(text,1,(any_arr){
        start
})
;
            //var opencount=1;
            var 
        opencount = any_number(1)
;
        ...
        any_number(n)
                ...
                else if (__is(METHOD(charAt_,text)(text,1,(any_arr){
        any_number(n)
}),opener))  {
                    //opencount++
...
//loop until no quotes found 
            //var anyQuote = '"' & "'"
            var 
        anyQuote = _concatAny(2,any_LTR("\""),any_LTR("'"))
;
            //var resultText=""
            var 
        resultText = any_EMPTY_STR
;
            //do 
            do{
                //var preQuotes=PMREX.untilRanges(text,anyQuote) 
                var 
        preQuotes = PMREX_untilRanges(undefined,2,(any_arr){
        text, 
        anyQuote
})
;
                ...
                text = METHOD(slice_,text)(text,1,(any_arr){
        any_number(_length(preQuotes))
});
                ...
                if (__is(METHOD(slice_,text)(text,2,(any_arr){
        any_number(0), 
        any_number(3)
}),any_LTR("\"\"\"")))  { //ignore triple quotes (valid token)
                    //resultText &= text.slice(0,3)
                    resultText=_concatAny(2,resultText,METHOD(slice_,text)(text,2,(any_arr){
        any_number(0), 
        any_number(3)
}));
                    //text = text.slice(3)
...
//method .remove(element)
        ...
        any Array_remove(DEFAULT_ARGUMENTS){
            ...
            var inx=undefined;
            if (_anyToNumber((inx=METHOD(indexOf_,this)(this,1,(any_arr){
        element
}))) >= 0)  {
                 //return this.splice(inx,1)
                 return METHOD(splice_,this)(this,2,(any_arr){
        inx, 
        any_number(1)
});
            };
