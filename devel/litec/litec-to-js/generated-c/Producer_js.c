...
//Produce all vars & functions definitions first.
        //var looseStatements=[]
        var 
        looseStatements = new(Array,0,NULL)
;
...
////            statement.produce
            //case statement.specific.constructor
                ...
                //when 
            if (__is(any_class(PROP(specific_,statement).class),Grammar_ImportStatement)||__is(any_class(PROP(specific_,statement).class),Grammar_VarStatement)||__is(any_class(PROP(specific_,statement).class),Grammar_ClassDeclaration)||__is(any_class(PROP(specific_,statement).class),Grammar_FunctionDeclaration)||__is(any_class(PROP(specific_,statement).class),Grammar_NamespaceDeclaration)||__is(any_class(PROP(specific_,statement).class),Grammar_AppendToDeclaration)){
                ...
                //else
                    ...
                    METHOD(push_,looseStatements)(looseStatements,1,(any_arr){
        statement
});
            };
        }};// end for each in
...
;
        //.out
            ...
            //{COMMENT: separ.repeat(20)},NL 
        METHOD(out_,this)(this,6,(any_arr){
        new(Map,1,(any_arr){
            _newPair("COMMENT",METHOD(repeat_,separ)(separ,1,(any_arr){
        any_number(20)
}))
            })
, 
        Producer_js_NL, 
        new(Map,1,(any_arr){
            _newPair("COMMENT",any_LTR("Module code"))
            })
, 
        Producer_js_NL, 
        new(Map,1,(any_arr){
...
, 
        ...
        //.out 
            ...
            //NL
        METHOD(out_,this)(this,4,(any_arr){
        Producer_js_NL, 
        new(Map,1,(any_arr){
            _newPair("COMMENT",any_LTR("end of module"))
            })
, 
        Producer_js_NL, 
        Producer_js_NL
...
//add end of file comments
        ...
        METHOD(outSourceLinesAsComment_,this)(this,1,(any_arr){
        any_number(_length(PROP(infoLines_,PROP(lexer_,this))))
});
...
//"Body"s are used for example, to parse an `if` statement body and `else` body, `for` loops, etc.
      ...
      any Grammar_Body_produce(DEFAULT_ARGUMENTS){
        ...
        //.out NL
        METHOD(out_,this)(this,1,(any_arr){
        Producer_js_NL
});
      return undefined;
      }
...
//To enhance compiled code readability, add original Lite line as comment 
        ...
        if (_anyToBool(PROP(comments_,PROP(options_,PROP(lexer_,this)))))  { // and .lexer.outCode.lastOriginalCodeComment<.lineInx
            ...
            var 
        commentTo = PROP(lastSourceLineNum_,this)
;
...
//declare vars before statement (exclude body of FunctionDeclaration)
        ...
        METHOD(callOnSubTree_,this)(this,2,(any_arr){
        any_LTR("declareIntoVar"), 
        Grammar_Body
});
//call the specific statement (if,for,print,if,function,class,etc) .produce()
        //var mark = .lexer.outCode.markSourceMap(.indent)
        var 
        mark = __call(markSourceMap_,PROP(outCode_,PROP(lexer_,this)),1,(any_arr){
        PROP(indent_,this)
})
;
        //.out .specific
...
//then NEWLINE
        ...
        if (!(_anyToBool(PROP(skipSemiColon_,PROP(specific_,this)))))  {
          //.addSourceMap mark
          METHOD(addSourceMap_,this)(this,1,(any_arr){
        mark
});
          //.out ";"
          METHOD(out_,this)(this,1,(any_arr){
...
//### append to class Grammar.ThrowStatement ###
      ...
      any Grammar_ThrowStatement_produce(DEFAULT_ARGUMENTS){
          ...
          if (__is(PROP(specifier_,this),any_LTR("fail")))  {
            ...
            METHOD(out_,this)(this,3,(any_arr){
        any_LTR("throw new Error("), 
        PROP(expr_,this), 
        any_LTR(")")
});
          }
          //else
            ...
            //.out "throw ", .expr
            METHOD(out_,this)(this,2,(any_arr){
        any_LTR("throw "), 
        PROP(expr_,this)
});
          };
...
//6) `bitnot`  *bit-unary-negation*   `a = bitnot xC0 + 5`
      ...
      any Grammar_UnaryOper_produce(DEFAULT_ARGUMENTS){
        ...
        var 
        translated = Producer_js_operTranslate(undefined,1,(any_arr){
        PROP(name_,this)
})
;
        //var prepend,append
...
//add a space if the unary operator is a word. Example `typeof`
        ...
        else if (_anyToNumber(METHOD(charAt_,translated)(translated,1,(any_arr){
        any_number(0)
})) >= 'a' && _anyToNumber(METHOD(charAt_,translated)(translated,1,(any_arr){
        any_number(0)
})) <= 'z')  {
            //translated &= " "
...
//example (`arguments` pseudo-array): `'lite' not in arguments` -> `Array.prototype.slice.call(arguments).indexOf(char)==-1`
        ...
        if (__is(PROP(name_,this),any_LTR("in")))  {
            ...
            METHOD(out_,this)(this,5,(any_arr){
        PROP(right_,this), 
        any_LTR(".indexOf("), 
        PROP(left_,this), 
        any_LTR(")"), 
...
//We out: left,operator,right
        ...
        PROP(left_,this), 
        any_LTR(" "), 
        Producer_js_operTranslate(undefined,1,(any_arr){
        oper
}), 
        any_LTR(" "), 
        PROP(right_,this), 
...
//Produce the expression body, negated if options={negated:true}
        //var prepend=""
        var 
        prepend = any_EMPTY_STR
;
        //var append=""
        var 
        append = any_EMPTY_STR
;
        //if negated
...
//Prefix ++/--, varName, Accessors and postfix ++/--
        ...
        if (__is(PROP(name_,this),any_LTR("arguments")))  { //the only thing that can be done with "arguments" is "arguments.toArray()"
            ...
            METHOD(out_,this)(this,1,(any_arr){
        any_LTR("Array.prototype.slice.call(arguments)")
});
            //return
            return undefined;
        };
        ...
        any_LTR("expected onTimeout(milliseconds,function)")
});
            };
            //var fnAccess: Grammar.FunctionAccess = .accessors[1]
            var 
        fnAccess = ITEM(1,PROP(accessors_,this))
;
            ...
            if (!__is(any_number(_length(PROP(args_,fnAccess))),any_number(2)))  {
                ...
                METHOD(sayErr_,this)(this,1,(any_arr){
        any_LTR("expected two arguments: onTimeout(milliseconds,function)")
});
            };
        ...
        //else 
            ...
            var 
        refNameDecl = METHOD(tryGetFromScope_,this)(this,1,(any_arr){
        PROP(name_,this)
})
;
            //if no refNameDecl
...
//### append to class Grammar.DefaultAssignment ###
      ...
      any Grammar_DefaultAssignment_produce(DEFAULT_ARGUMENTS){
        ...
        METHOD(process_,this)(this,2,(any_arr){
        PROP(lvalue_,PROP(assignment_,this)), 
...
//check if it's a ObjectLiteral (level indent)
          ...
          if (_instanceof(value,Grammar_ObjectLiteral))  {
            ...
            METHOD(processItems_,this)(this,2,(any_arr){
        name, 
        value
...
//else, simple value (Expression)
          //else
            ...
            METHOD(assignIfUndefined_,this)(this,2,(any_arr){
        name, 
        value
});// # Expression
          };
      ...
      any Grammar_DefaultAssignment_processItems(DEFAULT_ARGUMENTS){
        ...
        Producer_js_NL
          ...
          any _list68=PROP(items_,objectLiteral);
          { var nameValue=undefined;
          for(int nameValue__inx=0 ; nameValue__inx<_list68.value.arr->length ; nameValue__inx++){nameValue=ITEM(nameValue__inx,_list68);
          
            //var itemFullName = [main,'.',nameValue.name]
            var 
        itemFullName = new(Array,3,(any_arr){main, any_LTR("."), PROP(name_,nameValue)})
;
...
//More Helper methods, get max line of list
        ...
        var 
        lastLine = PROP(sourceLineNum_,this)
;
...
;
        ...
        while(_anyToBool(start) && _anyToBool((parent=METHOD(getParent_,start)(start,1,(any_arr){
        Grammar_ClassDeclaration
})))){
            //var ownerName, toPrototype
            var 
        ownerName = undefined, 
        toPrototype = undefined
;
            ...
            if (_instanceof(parent,Grammar_AppendToDeclaration))  {
                ...
                var 
        refNameDecl = __call(tryGetReference_,PROP(varRef_,parent),0,NULL)
;
            ...
            METHOD(unshift_,result)(result,2,(any_arr){
        ownerName, 
...
//'var' followed by a list of comma separated: var names and optional assignment
      ...
      any Grammar_PropertiesDeclaration_produce(DEFAULT_ARGUMENTS){
        ...
        METHOD(outSourceLinesAsComment_,this)(this,1,(any_arr){
        METHOD(lastLineOf_,this)(this,1,(any_arr){
        PROP(list_,this)
})
});
        ...
        for(int varDecl__inx=0 ; varDecl__inx<_list70.value.arr->length ; varDecl__inx++){varDecl=ITEM(varDecl__inx,_list70);
          ...
          if (_anyToBool(PROP(assignedValue_,varDecl)))  {// #is not valid to assign to .prototype. - creates subtle errors later
            ...
            if (_instanceof(prefix,Array) && _anyToBool(ITEM(1,prefix)) && !__is(ITEM(1,prefix),any_LTR("."))) {METHOD(throwError_,this)(this,1,(any_arr){
        any_LTR("cannot assign values to instance properties in \"Append to\"")
});};
...
//'var' followed by a list of comma separated: var names and optional assignment
      ...
      any Grammar_VarStatement_produce(DEFAULT_ARGUMENTS){
        ...
        if (__is(PROP(keyword_,this),any_LTR("let")) && _anyToBool(METHOD(compilerVar_,this)(this,1,(any_arr){
        any_LTR("ES6")
})))  {
          //.out 'let '
          METHOD(out_,this)(this,1,(any_arr){
...
, 
        Producer_js_NL
                ...
                //for each varDecl in .list
                any _list71=PROP(list_,this);
                { var varDecl=undefined;
                for(int varDecl__inx=0 ; varDecl__inx<_list71.value.arr->length ; varDecl__inx++){varDecl=ITEM(varDecl__inx,_list71);
...
//A name  without "./"" means "look in $PATH" (node_modules and up)
        ...
        var 
        thisModule = METHOD(getParent_,this)(this,1,(any_arr){
        Grammar_Module
})
;
//get the required file path, relative to the location of this module (as nodejs's require() requires)
        ...
        var 
        fn = Environment_relativeFrom(undefined,2,(any_arr){
        Environment_getDir(undefined,1,(any_arr){
        PROP(outFilename_,PROP(fileInfo_,thisModule))
}), 
        PROP(outFilename_,PROP(fileInfo_,PROP(importedModule_,this)))
})
;
...
//check for 'import x from 'path/file';
        ...
        if (_anyToBool(PROP(importParameter_,this)) && __is(METHOD(charAt_,fn)(fn,1,(any_arr){
        any_number(0)
...
//(ES6 implements 'default' for parameters, so `function myFunc(a=3)` is valid in ES6)
          //else
            ...
            if (_anyToBool(PROP(assignedValue_,this)) && _anyToBool(__call(compilerVar_,PROP(project_,PROP(lexer_,this)),1,(any_arr){
        any_LTR("ES6")
})))  {
                //.out ' = ',.assignedValue
                METHOD(out_,this)(this,2,(any_arr){
...
//### Append to class Grammar.SingleLineBody ###
      ...
      any Grammar_SingleLineBody_produce(DEFAULT_ARGUMENTS){
        ...
        //var bare=[]
        var 
        bare = new(Array,0,NULL)
;
        //for each statement in .statements
        any _list72=PROP(statements_,this);
        { var statement=undefined;
        for(int statement__inx=0 ; statement__inx<_list72.value.arr->length ; statement__inx++){statement=ITEM(statement__inx,_list72);
        
            //bare.push statement.specific
            METHOD(push_,bare)(bare,1,(any_arr){
        PROP(specific_,statement)
});
        }};// end for each in
    ...
    //Append to class Grammar.Expression
      ...
      any Grammar_Expression_prepareTempVar(DEFAULT_ARGUMENTS){
        ...
        if (_anyToBool((_anyToBool(__or8=(_anyToBool(__or9=any_number(_anyToNumber(PROP(operandCount_,this)) > 1))? __or9 : PROP(hasSideEffects_,PROP(name_,PROP(root_,this)))))? __or8 : any_number(_instanceof(PROP(name_,PROP(root_,this)),Grammar_Literal)))))  {
            ...
            var 
        tempVarIterable = UniqueID_getVarName(undefined,1,(any_arr){
        any_LTR("list")
})
...
//`ForEachProperty: for each [own] property name-VariableDecl in object-VariableRef`
      ...
      any Grammar_ForEachProperty_produce(DEFAULT_ARGUMENTS){
          ...
          var 
        iterable = __call(prepareTempVar_,PROP(iterable_,this),0,NULL)
;
          //if .mainVar
        ...
        Producer_js_NL
          ...
          var 
        index = (_anyToBool(__or10=PROP(indexVar_,this))? __or10 : UniqueID_getVarName(undefined,1,(any_arr){
        any_LTR("inx")
}))
;
        ...
        any_LTR("))")
          ...
          __call(out_,PROP(body_,this),8,(any_arr){
        any_LTR("{"), 
        PROP(name_,PROP(mainVar_,this)), 
        any_LTR("="), 
        iterable, 
        ...
        PROP(where_,this)
          ...
          //.body.out "{", .body, "}",NL
          __call(out_,PROP(body_,this),4,(any_arr){
        any_LTR("{"), 
        PROP(body_,this), 
        any_LTR("}"), 
        Producer_js_NL
          ...
          //.body.out NL, "}"
          __call(out_,PROP(body_,this),2,(any_arr){
        Producer_js_NL, 
        any_LTR("}")
});
...
;
        ...
        if (_anyToBool(PROP(isMap_,this)))  { //new syntax "for each in map xx"
            ...
            return METHOD(produceInMap_,this)(this,1,(any_arr){
        iterable
});
        };
...
;
        ...
        //.out "for( var "
        METHOD(out_,this)(this,14,(any_arr){
        any_LTR("for( var "), 
        indexVarName, 
        any_LTR("="), 
        startValue, 
        ...
        __call(out_,PROP(body_,this),7,(any_arr){
        PROP(name_,PROP(mainVar_,this)), 
        any_LTR("="), 
        iterable, 
        any_LTR("["), 
...
//Handle by using a js/C standard for(;;){} loop
      ...
      any Grammar_ForIndexNumeric_produce(DEFAULT_ARGUMENTS){
        ...
        var 
        isToDownTo = undefined
;
        //var endTempVarName
        var 
        endTempVarName = undefined
;
...
//For loops "to/down to" evaluate end expresion only once
            ...
            endTempVarName = UniqueID_getVarName(undefined,1,(any_arr){
        any_LTR("end")
});
...
//Produce the condition, negated if the prefix is 'until'.
            ...
            __call(produce_,PROP(endExpression_,this),1,(any_arr){
        any_number(__is(PROP(conditionPrefix_,this),any_LTR("until")))
});
        };
        //.out "; "
        METHOD(out_,this)(this,1,(any_arr){
...
//to produce a `while` condition. (`while NOT x` is equivalent to `until x`)
        ...
        __call(produce_,PROP(expr_,this),1,(any_arr){
        negated
});
      return undefined;
      }
...
//if we have a post-condition, for example: `do ... loop while x>0`, 
        ...
        any_LTR("} while (")
            ...
            __call(produce_,PROP(postWhileUntilExpression_,this),1,(any_arr){
        any_LTR("while")
});
            //.out ")"
            METHOD(out_,this)(this,1,(any_arr){
...
//else, optional pre-condition:
        ...
        any_LTR("while(")
            ...
            if (_anyToBool(PROP(preWhileUntilExpression_,this)))  {
              ...
              __call(produce_,PROP(preWhileUntilExpression_,this),1,(any_arr){
        any_LTR("while")
});
            }
            //else 
...
;
        ...
        while(TRUE){
            ...
            if (_instanceof(nodeASTBase,Grammar_FunctionDeclaration))  {
                ...
                METHOD(sayErr_,this)(this,1,(any_arr){
        any_LTR("\"{.control}\" outside a for|while|do loop")
});
                //break
                break;
            }
...
//(one NameValuePair per line, indented, comma is optional)
      ...
      any Grammar_ObjectLiteral_produce(DEFAULT_ARGUMENTS){
          ...
          if (_anyToBool(PROP(isMap_,this))) {METHOD(out_,this)(this,1,(any_arr){
        any_LTR("new Map().fromObject(")
});};
...
//`generator` prefix marks a 'generator' function that can be paused by `yield` (js/ES6 function*)
     ...
     any Grammar_FunctionDeclaration_produce(DEFAULT_ARGUMENTS){
      ...
      var 
        isConstructor = any_number(_instanceof(this,Grammar_ConstructorDeclaration))
;
      ...
      var 
        generatorMark = _anyToBool(METHOD(hasAdjective_,this)(this,1,(any_arr){
        any_LTR("generator")
})) && _anyToBool(__call(compilerVar_,PROP(project_,PROP(lexer_,this)),1,(any_arr){
        any_LTR("ES6")
      ...
      if (_instanceof(this,Grammar_MethodDeclaration))  {
        ...
        Producer_js_NL
          ...
          if (_anyToBool(PROP(definePropItems_,this)))  {// #we should code Object.defineProperty
              ...
              if (__is(__call(slice_,ITEM(1,prefix),1,(any_arr){
        any_number(-1)
}),any_LTR("."))) {ITEM(1,prefix) = __call(slice_,ITEM(1,prefix),2,(any_arr){
        any_number(0), 
        any_number(-1)
});};
              //.out "Object.defineProperty(",NL,
              METHOD(out_,this)(this,7,(any_arr){
        any_LTR("Object.defineProperty("), 
        Producer_js_NL, 
        prefix, 
        any_LTR(",'"), 
        PROP(name_,this), 
...
//if 'nice', produce default nice body, and then the generator header for real body
      ...
      var 
        isNice = any_number(_anyToBool(METHOD(hasAdjective_,this)(this,1,(any_arr){
        any_LTR("nice")
})) && !((_anyToBool((_anyToBool(__or14=(_anyToBool(__or15=(_anyToBool(__or16=isConstructor)? __or16 : METHOD(hasAdjective_,this)(this,1,(any_arr){
        any_LTR("shim")
})))? __or15 : PROP(definePropItems_,this)))? __or14 : METHOD(hasAdjective_,this)(this,1,(any_arr){
        any_LTR("generator")
}))))))
;
      //if isNice
      if (_anyToBool(isNice))  {
          ...
          var 
        argsArray = (_anyToBool(__or17=PROP(paramsDeclarations_,this))? __or17 : new(Array,0,NULL))
;
          //argsArray.push "__callback"
          METHOD(push_,argsArray)(argsArray,1,(any_arr){
        any_LTR("__callback")
});
...
//if we were coding .definePropItems , close Object.defineProperty
      ...
      if (_anyToBool(PROP(definePropItems_,this)))  {
          ...
          any _list73=PROP(definePropItems_,this);
          { var definePropItem=undefined;
          for(int definePropItem__inx=0 ; definePropItem__inx<_list73.value.arr->length ; definePropItem__inx++){definePropItem=ITEM(definePropItem__inx,_list73);
...
//If the function was adjectivated 'export', add to module.exports
      //.produceExport .name
      METHOD(produceExport_,this)(this,1,(any_arr){
        PROP(name_,this)
});
     return undefined;
     }
...
//if it has a "catch" or "exception", insert 'try{'
          ...
          any _list74=PROP(statements_,PROP(body_,this));
          { var statement=undefined;
          for(int statement__inx=0 ; statement__inx<_list74.value.arr->length ; statement__inx++){statement=ITEM(statement__inx,_list74);
...
//(if ES6 enabled, they were included abobve in ParamsDeclarations production )
          ...
          if (_anyToBool(PROP(paramsDeclarations_,this)) && !(_anyToBool(__call(compilerVar_,PROP(project_,PROP(lexer_,this)),1,(any_arr){
        any_LTR("ES6")
}))))  {
              //for each paramDecl in .paramsDeclarations
              any _list75=PROP(paramsDeclarations_,this);
              { var paramDecl=undefined;
              for(int paramDecl__inx=0 ; paramDecl__inx<_list75.value.arr->length ; paramDecl__inx++){paramDecl=ITEM(paramDecl__inx,_list75);
                ...
                if (_anyToBool(PROP(assignedValue_,paramDecl)))  {
                    ...
                    __call(assignIfUndefined_,PROP(body_,this),2,(any_arr){
        PROP(name_,paramDecl), 
...
//close the function, add source map for function default "return undefined" execution point
      ...
      if (_anyToBool(PROP(sourceMap_,PROP(outCode_,PROP(lexer_,this)))))  {
          ...
          __call(add_,PROP(sourceMap_,PROP(outCode_,PROP(lexer_,this))),4,(any_arr){
        PROP(EndFnLineNum_,this), 
        any_number(0), 
...
//out this line as comment 
        ...
        METHOD(outSourceLineAsComment_,this)(this,1,(any_arr){
...
//Out as comments
      ...
      any Grammar_DeclareStatement_produce(DEFAULT_ARGUMENTS){
        ...
        METHOD(outSourceLinesAsComment_,this)(this,2,(any_arr){
        PROP(sourceLineNum_,this), 
        _anyToBool(PROP(names_,this)) ? METHOD(lastLineOf_,this)(this,1,(any_arr){
        PROP(names_,this)
}) : PROP(sourceLineNum_,this)
});
        //.skipSemiColon = true
...
//we need to get the class constructor, and separate other class items.
        ...
        var 
        theConstructorDeclaration = null
;
        //var theMethods = []
        var 
        theMethods = new(Array,0,NULL)
;
        //var theProperties = []
        var 
        theProperties = new(Array,0,NULL)
;
        //if .body
        if (_anyToBool(PROP(body_,this)))  {
          //for each index,item in .body.statements
          any _list76=PROP(statements_,PROP(body_,this));
          { var item=undefined;
          for(int index=0 ; index<_list76.value.arr->length ; index++){item=ITEM(index,_list76);
            ...
            if (_instanceof(PROP(specific_,item),Grammar_ConstructorDeclaration))  {
              ...
              if (_anyToBool(theConstructorDeclaration))  {// # what? more than one?
                ...
                METHOD(throwError_,this)(this,1,(any_arr){
        _concatAny(2,
        any_LTR("Two constructors declared for class "), 
        PROP(name_,this)
)
});
              };
            ...
            //else if item.specific instanceof Grammar.PropertiesDeclaration
              ...
              METHOD(push_,theProperties)(theProperties,1,(any_arr){
        PROP(specific_,item)
});
            }
            //else 
              ...
              METHOD(push_,theMethods)(theMethods,1,(any_arr){
        item
});
            };
          }};// end for each in
        ...
        var 
        prefix = METHOD(getOwnerPrefix_,this)(this,0,NULL)
;
...
//initialize own properties
        ...
        any _list77=theProperties;
        { var propDecl=undefined;
        for(int propDecl__inx=0 ; propDecl__inx<_list77.value.arr->length ; propDecl__inx++){propDecl=ITEM(propDecl__inx,_list77);
        
            //propDecl.produce('this.') //property assignments
            METHOD(produce_,propDecl)(propDecl,1,(any_arr){
        any_LTR("this.")
...
//now out methods, meaning: create properties in the object-function-class prototype
        ...
        any _list78=theMethods;
        { var itemMethodDeclaration=undefined;
        for(int itemMethodDeclaration__inx=0 ; itemMethodDeclaration__inx<_list78.value.arr->length ; itemMethodDeclaration__inx++){itemMethodDeclaration=ITEM(itemMethodDeclaration__inx,_list78);
        
            //itemMethodDeclaration.produce undefined, prefix
            METHOD(produce_,itemMethodDeclaration)(itemMethodDeclaration,2,(any_arr){
        undefined, 
        prefix
});
        }};// end for each in
...
//if we have a varRef, is a case over a value
        ...
        for(int index=0 ; index<_list79.value.arr->length ; index++){whenSection=ITEM(index,_list79);
            ...
            METHOD(outSourceLineAsComment_,this)(this,1,(any_arr){
        PROP(sourceLineNum_,whenSection)
});
            //.out index>0? 'else ' : '' 
            METHOD(out_,this)(this,1,(any_arr){
        index > 0 ? any_LTR("else ") : any_EMPTY_STR
});
            //if .varRef
        ...
        new(Map,5,(any_arr){
                ...
                _newPair("separator",any_LTR("||")), 
                _newPair("freeForm",any_number(1))
                })
...
//else body
        ...
        if (_anyToBool(PROP(elseBody_,this))) {METHOD(out_,this)(this,4,(any_arr){
        Producer_js_NL, 
        any_LTR("else {"), 
        PROP(elseBody_,this), 
        any_LTR("}")
...
//##### method produceInstanceOfLoop
      any Grammar_CaseStatement_produceInstanceOfLoop(DEFAULT_ARGUMENTS){
        ...
        var 
        tmpVar = UniqueID_getVarName(undefined,1,(any_arr){
        any_LTR("class")
})
;
        //.out "Class_ptr ",tmpVar," = ",.varRef,".class;",NL,
        METHOD(out_,this)(this,10,(any_arr){
        any_LTR("Class_ptr "), 
        tmpVar, 
        any_LTR(" = "), 
        PROP(varRef_,this), 
        ...
        Producer_js_NL
            ...
            //"while(",tmpVar,"){",NL
        //for each index,whenSection in .cases
        any _list80=PROP(cases_,this);
        { var whenSection=undefined;
        for(int index=0 ; index<_list80.value.arr->length ; index++){whenSection=ITEM(index,_list80);
        ...
        PROP(sourceLineNum_,whenSection)
            ...
            METHOD(out_,whenSection)(whenSection,9,(any_arr){
        index > 0 ? any_LTR("else ") : any_EMPTY_STR, 
        any_LTR("if ("), 
        new(Map,4,(any_arr){
...
//Check location
        ...
        if (_anyToBool((_anyToBool(__or19=any_number(!(_anyToBool((functionDeclaration=METHOD(getParent_,this)(this,1,(any_arr){
        Grammar_FunctionDeclaration
}))))))? __or19 : any_number(!_anyToBool(METHOD(hasAdjective_,functionDeclaration)(functionDeclaration,1,(any_arr){
        any_LTR("nice")
}))))))  {
            //or no functionDeclaration.hasAdjective("nice")
                //.throwError '"yield" can only be used inside a "nice function/method"'
                METHOD(throwError_,this)(this,1,(any_arr){
        any_LTR("\"yield\" can only be used inside a \"nice function/method\"")
});
        };
        //var yieldArr=[]
        var 
        yieldArr = new(Array,0,NULL)
;
        //var varRef = .fnCall.varRef
        var 
        varRef = PROP(varRef_,PROP(fnCall_,this))
;
        ////from .varRef calculate object owner and method name 
        //var thisValue=['null']
        var 
        thisValue = new(Array,1,(any_arr){any_LTR("null")})
;
        //var fnName = varRef.name #default if no accessors 
        var 
        fnName = PROP(name_,varRef)
;// #default if no accessors
        //if varRef.accessors
        if (_anyToBool(PROP(accessors_,varRef)))  {
            //var inx=varRef.accessors.length-1
            var 
        inx = any_number(_length(PROP(accessors_,varRef)) - 1)
;
            ...
            if (_instanceof(ITEM(_anyToNumber(inx),PROP(accessors_,varRef)),Grammar_FunctionAccess))  {
                ...
                var 
        functionAccess = ITEM(_anyToNumber(inx),PROP(accessors_,varRef))
;
            ...
            if (_anyToNumber(inx) >= 0)  {
                ...
                if (!(_instanceof(ITEM(_anyToNumber(inx),PROP(accessors_,varRef)),Grammar_PropertyAccess)))  {
                    ...
                    METHOD(throwError_,this)(this,1,(any_arr){
        any_LTR("yield needs a clear method name. Example: \"yield until obj.method(10)\". redefine yield parameter.")
});
                };
        ...
        any_LTR("'")
                ...
                METHOD(push_,thisValue)(thisValue,1,(any_arr){
        __call(slice_,PROP(accessors_,varRef),2,(any_arr){
        any_number(0), 
        inx
})
});
        ...
        if (__is(PROP(specifier_,this),any_LTR("until")))  {
            ...
            METHOD(unshift_,yieldArr)(yieldArr,1,(any_arr){
        fnName
});
        ...
        //else #parallel map
            ...
            METHOD(push_,yieldArr)(yieldArr,4,(any_arr){
        any_LTR("'map'"), 
...
//Many LiteScript operators can be easily mapped one-to-one with their JavaScript equivalents.
    ...
    any Producer_js_operTranslate(DEFAULT_ARGUMENTS){
      ...
      return (_anyToBool(__or20=METHOD(get_,Producer_js_OPER_TRANSLATION_map)(Producer_js_OPER_TRANSLATION_map,1,(any_arr){
        name
}))? __or20 : name);
    return undefined;
    }
...
//#### helper method assignIfUndefined(name, value: Grammar.Expression) 
     any ASTBase_assignIfUndefined(DEFAULT_ARGUMENTS){
          ...
          var 
        varRef = PROP(name_,PROP(root_,value))
;
...
, 
        ...
        Producer_js_NL
          ...
          METHOD(out_,this)(this,8,(any_arr){
        any_LTR("if("), 
        name, 
        any_LTR("===undefined) "), 
        name, 
...
;
        ...
        else if (_anyToBool(METHOD(hasAdjective_,this)(this,1,(any_arr){
        any_LTR("export")
})))  {
            //.out NL,{COMMENT:'export'},NL
            METHOD(out_,this)(this,3,(any_arr){
...
//------------------
void Producer_js__namespaceInit(void){
