...
//Produce all vars & functions definitions first.
        ...
        //var looseStatements=[]
        var looseStatements = new(Array,0,NULL)
        ;
...
//            statement.produce
            ...
            if (__is(any_class(PROP(specific_,statement).class),Grammar_ImportStatement)||__is(any_class(PROP(specific_,statement).class),Grammar_VarStatement)||__is(any_class(PROP(specific_,statement).class),Grammar_ClassDeclaration)||__is(any_class(PROP(specific_,statement).class),Grammar_FunctionDeclaration)||__is(any_class(PROP(specific_,statement).class),Grammar_NamespaceDeclaration)||__is(any_class(PROP(specific_,statement).class),Grammar_AppendToDeclaration)){
                ...
                //else
                    ...
                    METHOD(push_,looseStatements)(looseStatements,1,(any_arr){statement
                    });
            };
        }};// end for each in
        ...
        //.out
            ...
            //{COMMENT: separ.repeat(20)},NL 
        METHOD(out_,this)(this,6,(any_arr){new(Map,1,(any_arr){
            _newPair("COMMENT",METHOD(repeat_,separ)(separ,1,(any_arr){any_number(20)
            }))
            })
        ...
        any _list68=looseStatements;
        { var statement=undefined;
        for(int statement__inx=0 ; statement__inx<_list68.value.arr->length ; statement__inx++){statement=ITEM(statement__inx,_list68);
...
//"Body"s are used for example, to parse an `if` statement body and `else` body, `for` loops, etc.
      ...
      any Grammar_Body_produce(DEFAULT_ARGUMENTS){
        ...
        { var statement=undefined;
        for(int statement__inx=0 ; statement__inx<_list69.value.arr->length ; statement__inx++){statement=ITEM(statement__inx,_list69);
...
//else, simple value (Expression)
      ...
      any Grammar_DefaultAssignment_processItems(DEFAULT_ARGUMENTS){
          ...
          any _list70=PROP(items_,objectLiteral);
          { var nameValue=undefined;
          for(int nameValue__inx=0 ; nameValue__inx<_list70.value.arr->length ; nameValue__inx++){nameValue=ITEM(nameValue__inx,_list70);
...
//'var' followed by a list of comma separated: var names and optional assignment
      ...
      any Grammar_PropertiesDeclaration_produce(DEFAULT_ARGUMENTS){
        ...
        any _list72=PROP(list_,this);
        { var varDecl=undefined;
        for(int varDecl__inx=0 ; varDecl__inx<_list72.value.arr->length ; varDecl__inx++){varDecl=ITEM(varDecl__inx,_list72);
...
//If 'var' was adjectivated 'export', add all vars to exportNamespace
        ...
        if (!(_anyToBool(PROP(browser_,PROP(outCode_,PROP(lexer_,this))))))  {
            ...
            if (_anyToBool(METHOD(hasAdjective_,this)(this,1,(any_arr){any_LTR("export")
                ...
                //for each varDecl in .list
                any _list73=PROP(list_,this);
                { var varDecl=undefined;
                for(int varDecl__inx=0 ; varDecl__inx<_list73.value.arr->length ; varDecl__inx++){varDecl=ITEM(varDecl__inx,_list73);
...
//A name  without "./"" means "look in $PATH" (node_modules and up)
        ...
        if (_anyToBool((_anyToBool(__or5=any_number(!_anyToBool(PROP(importedModule_,this))))? __or5 : PROP(globalImport_,PROP(importInfo_,PROP(fileInfo_,PROP(importedModule_,this)))))))  {
...
//get the required file path, relative to the location of this module (as nodejs's require() requires)
        ...
        var fn = Environment_relativeFrom(undefined,2,(any_arr){Environment_getDir(undefined,1,(any_arr){PROP(outFilename_,PROP(fileInfo_,thisModule))
        })
...
//in LiteScript, 'var' declaration assigns 'undefined')
          ...
          if (_instanceof(PROP(parent_,this),Grammar_VarStatement))  {
              ...
              METHOD(out_,this)(this,2,(any_arr){any_LTR(" = ")
              , (_anyToBool(__or6=PROP(assignedValue_,this))? __or6 : any_LTR("undefined"))
              });
          }
...
//We create a temp var to assign the iterable expression to
    ...
    //Append to class Grammar.Expression
      ...
      any Grammar_Expression_prepareTempVar(DEFAULT_ARGUMENTS){
        ...
        if (_anyToBool((_anyToBool(__or7=(_anyToBool(__or8=any_number(_anyToNumber(PROP(operandCount_,this)) > 1))? __or8 : PROP(hasSideEffects_,PROP(name_,PROP(root_,this)))))? __or7 : any_number(_instanceof(PROP(name_,PROP(root_,this)),Grammar_Literal)))))  {
...
//`ForEachProperty: for each [own] property name-VariableDecl in object-VariableRef`
      ...
      any Grammar_ForEachProperty_produce(DEFAULT_ARGUMENTS){
          ...
          var index = (_anyToBool(__or9=PROP(indexVar_,this))? __or9 : UniqueID_getVarName(undefined,1,(any_arr){any_LTR("inx")
          }))
          ;
...
//Create a default index var name if none was provided
        ...
        //else
            ...
            startValue = (_anyToBool(__or10=PROP(assignedValue_,PROP(indexVar_,this)))? __or10 : any_LTR("0"));
        };
...
//For loops "to/down to" evaluate end expresion only once
        ...
        , any_LTR("=")
        , (_anyToBool(__or11=PROP(assignedValue_,PROP(indexVar_,this)))? __or11 : any_LTR("0"))
        , any_LTR("; ")
        });
...
//validate usage inside a for/while
        ...
        while(TRUE){
            ...
            else if (_anyToBool((_anyToBool(__or12=any_number(_instanceof(nodeASTBase,Grammar_ForStatement)))? __or12 : any_number(_instanceof(nodeASTBase,Grammar_DoLoop)))))  {
...
//if 'nice', produce default nice body, and then the generator header for real body
      ...
      })) && !((_anyToBool((_anyToBool(__or13=(_anyToBool(__or14=(_anyToBool(__or15=isConstructor)? __or15 : METHOD(hasAdjective_,this)(this,1,(any_arr){any_LTR("shim")
      })))? __or14 : PROP(definePropItems_,this)))? __or13 : METHOD(hasAdjective_,this)(this,1,(any_arr){any_LTR("generator")
      }))))))
      ;
      //if isNice
      if (_anyToBool(isNice))  {
          //var argsArray:array = .paramsDeclarations or []
          var argsArray = (_anyToBool(__or16=PROP(paramsDeclarations_,this))? __or16 : new(Array,0,NULL))
          ;
...
//if we were coding .definePropItems , close Object.defineProperty
      ...
      if (_anyToBool(PROP(definePropItems_,this)))  {
          ...
          any _list75=PROP(definePropItems_,this);
          { var definePropItem=undefined;
          for(int definePropItem__inx=0 ; definePropItem__inx<_list75.value.arr->length ; definePropItem__inx++){definePropItem=ITEM(definePropItem__inx,_list75);
...
//if the function has a exception block, insert 'try{'
      ...
      if (_anyToBool((_anyToBool(__or17=any_number(!_anyToBool(PROP(body_,this))))? __or17 : any_number(!_anyToBool(PROP(statements_,PROP(body_,this)))))))  { //interface function?
...
//(if ES6 enabled, they were included abobve in ParamsDeclarations production )
          ...
          if (_anyToBool(PROP(paramsDeclarations_,this)) && !(_anyToBool(__call(compilerVar_,PROP(project_,PROP(lexer_,this)),1,(any_arr){any_LTR("ES6")
              ...
              any _list77=PROP(paramsDeclarations_,this);
              { var paramDecl=undefined;
              for(int paramDecl__inx=0 ; paramDecl__inx<_list77.value.arr->length ; paramDecl__inx++){paramDecl=ITEM(paramDecl__inx,_list77);
...
//we need to get the class constructor, and separate other class items.
        ...
        if (_anyToBool(PROP(body_,this)))  {
          ...
          any _list78=PROP(statements_,PROP(body_,this));
          { var item=undefined;
          for(int index=0 ; index<_list78.value.arr->length ; index++){item=ITEM(index,_list78);
...
//initialize own properties
        ...
        any _list79=theProperties;
        { var propDecl=undefined;
        for(int propDecl__inx=0 ; propDecl__inx<_list79.value.arr->length ; propDecl__inx++){propDecl=ITEM(propDecl__inx,_list79);
...
//now out methods, meaning: create properties in the object-function-class prototype
        ...
        any _list80=theMethods;
        { var itemMethodDeclaration=undefined;
        for(int itemMethodDeclaration__inx=0 ; itemMethodDeclaration__inx<_list80.value.arr->length ; itemMethodDeclaration__inx++){itemMethodDeclaration=ITEM(itemMethodDeclaration__inx,_list80);
...
//if we have a varRef, is a case over a value
        ...
        any _list81=PROP(cases_,this);
        { var whenSection=undefined;
        for(int index=0 ; index<_list81.value.arr->length ; index++){whenSection=ITEM(index,_list81);
...
//##### method produceInstanceOfLoop
      any Grammar_CaseStatement_produceInstanceOfLoop(DEFAULT_ARGUMENTS){
        ...
        //for each index,whenSection in .cases
        any _list82=PROP(cases_,this);
        { var whenSection=undefined;
        for(int index=0 ; index<_list82.value.arr->length ; index++){whenSection=ITEM(index,_list82);
...
//Check location
        ...
        if (_anyToBool((_anyToBool(__or18=any_number(!(_anyToBool((functionDeclaration=METHOD(getParent_,this)(this,1,(any_arr){Grammar_FunctionDeclaration
        }))))))? __or18 : any_number(!_anyToBool(METHOD(hasAdjective_,functionDeclaration)(functionDeclaration,1,(any_arr){any_LTR("nice")
            }))))))  {
...
//Many LiteScript operators can be easily mapped one-to-one with their JavaScript equivalents.
    ...
    any Producer_js_operTranslate(DEFAULT_ARGUMENTS){
      ...
      return (_anyToBool(__or19=METHOD(get_,Producer_js_OPER_TRANSLATION_map)(Producer_js_OPER_TRANSLATION_map,1,(any_arr){name
      }))? __or19 : name);
    return undefined;
    }
