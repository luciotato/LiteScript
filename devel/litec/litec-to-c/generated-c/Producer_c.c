...
//create _dispatcher.c & .h
        ...
        PROP(lexer_,Producer_c_dispatcherModule) = new(Parser_Lexer,2,(any_arr){project
, PROP(options_,project)
        });
        //project.redirectOutput dispatcherModule.lexer.outCode // all Lexers now out here        
        METHOD(redirectOutput_,project)(project,1,(any_arr){PROP(outCode_,PROP(lexer_,Producer_c_dispatcherModule))
        }); // all Lexers now out here
        //dispatcherModule.fileInfo = Environment.fileInfoNewFile("_dispatcher", project.options.target)
        PROP(fileInfo_,Producer_c_dispatcherModule) = Environment_fileInfoNewFile(undefined,2,(any_arr){any_LTR("_dispatcher")
, PROP(target_,PROP(options_,project))
        ...
        ITEM(1,PROP(filenames_,PROP(outCode_,PROP(lexer_,Producer_c_dispatcherModule)))) = _concatAny(2,(__call(slice_,PROP(outFilename_,PROP(fileInfo_,Producer_c_dispatcherModule)),2,(any_arr){any_number(0)
, any_number(-1)
        }))
, any_LTR("h")
        );
        ...
        logger_msg(undefined,1,(any_arr){_concatAny(5,color_green
, any_LTR("[OK] -> ")
, PROP(outRelFilename_,PROP(fileInfo_,Producer_c_dispatcherModule))
, any_LTR(" ")
, color_normal
        )
        });
    ...
    any Producer_c_normalizeDefine(DEFAULT_ARGUMENTS){
        ...
        for(int64_t n=0; n<=_end6; n++){
            ...
            chr = __call(toUpperCase_,METHOD(charAt_,name)(name,1,(any_arr){any_number(n)
            }),0,NULL);
...
, Producer_c_NL
, _concatAny(3,any_LTR("#ifndef ")
, (Producer_c_normalizeDefine(undefined,1,(any_arr){PROP(outRelFilename_,PROP(fileInfo_,this))
            }))
, any_LTR("_H")
            )
, Producer_c_NL
, _concatAny(3,any_LTR("#define ")
, (Producer_c_normalizeDefine(undefined,1,(any_arr){PROP(outRelFilename_,PROP(fileInfo_,this))
            }))
, any_LTR("_H")
            )
...
//LiteC__init extern declaration
        ...
        METHOD(out_,this)(this,6,(any_arr){Producer_c_NL
, new(Map,1,(any_arr){
            _newPair("COMMENT",any_LTR("core support and defined classes init"))
            })
            
, Producer_c_NL
, any_LTR("extern void __declareClasses();")
, Producer_c_NL
, Producer_c_NL
            });
//verbs & things
...
, Producer_c_NL
, Producer_c_NL
, any_LTR("enum _VERBS { //a symbol for each distinct method name")
, Producer_c_NL
            });
        //var initialValue = " = -_CORE_METHODS_MAX-#{allMethodNames.size}"
        var initialValue = _concatAny(2,any_LTR(" = -_CORE_METHODS_MAX-")
, PROP(size_,Producer_c_allMethodNames)
        );
        //for each methodDeclaration in map allMethodNames
        any _list63=Producer_c_allMethodNames;
...
, Producer_c_makeSymbolName(undefined,1,(any_arr){PROP(name_,methodDeclaration)
            })
, initialValue
, any_LTR(",")
, Producer_c_NL
        ...
        METHOD(out_,this)(this,3,(any_arr){Producer_c_NL
, any_LTR("_LAST_VERB};")
, Producer_c_NL
        });
...
, Producer_c_NL
        ...
        for(int64_t __inx=0 ; __inx < __len ; __inx++ ){
            ...
            METHOD(out_,this)(this,5,(any_arr){any_LTR("    ")
, Producer_c_makeSymbolName(undefined,1,(any_arr){name
            })
, initialValue
, any_LTR(",")
, Producer_c_NL
        ...
        METHOD(out_,this)(this,5,(any_arr){Producer_c_NL
, any_LTR("_LAST_THING};")
, Producer_c_NL
, Producer_c_NL
, Producer_c_NL
...
//declared and the C compiler shows errors everywhere
        ...
        any _list65=PROP(moduleCache_,project);
        {NameValuePair_ptr __nvp=NULL; //name:value pair
        int64_t __len=MAPSIZE(_list65); //how many pairs
        var moduleNode=undefined; //value
        for(int64_t __inx=0 ; __inx < __len ; __inx++ ){
            __nvp = MAPITEM( __inx,_list65);
            ...
            hFile = Environment_relativeFrom(undefined,2,(any_arr){PROP(outDir_,PROP(fileInfo_,this))
, hFile
            });
            //.out '#include "#{hFile}"',NL
            METHOD(out_,this)(this,2,(any_arr){_concatAny(3,any_LTR("#include \"")
, hFile
, any_LTR("\"")
            )
, Producer_c_NL
...
, Producer_c_NL
, Producer_c_NL
, any_LTR("static str _ADD_VERBS[] = { //string name for each distinct method name")
, Producer_c_NL
, new(Map,3,(any_arr){
...
, Producer_c_NL
, Producer_c_NL
, any_LTR("static str _ADD_THINGS[] = { //string name for each distinct property name")
, Producer_c_NL
, new(Map,3,(any_arr){
            _newPair("pre",any_LTR("    \"")), 
...
, Producer_c_NL
, any_LTR("int main(int argc, char** argv) {")
, Producer_c_NL
, _concatAny(3,any_LTR("    LiteC_init( ")
, any_number(_length(Producer_c_allClasses))
, any_LTR(", argc,argv);")
            )
, Producer_c_NL
, _concatAny(3,any_LTR("    LiteC_addMethodSymbols( ")
, PROP(size_,Producer_c_allMethodNames)
, any_LTR(", _ADD_VERBS);")
            )
, Producer_c_NL
, _concatAny(3,any_LTR("    LiteC_addPropSymbols( ")
, PROP(size_,Producer_c_allPropertyNames)
, any_LTR(", _ADD_THINGS);")
            )
, Producer_c_NL
            });
...
//process methods appended to core classes, by calling LiteC_registerShim
        ...
        any _list66=Producer_c_appendToCoreClassMethods;
        { var methodDeclaration=undefined;
        for(int methodDeclaration__inx=0 ; methodDeclaration__inx<_list66.value.arr->length ; methodDeclaration__inx++){methodDeclaration=ITEM(methodDeclaration__inx,_list66);
                ...
                METHOD(out_,this)(this,8,(any_arr){any_LTR("    LiteC_registerShim(")
, PROP(varRef_,appendToDeclaration)
, _concatAny(3,any_LTR(",")
, PROP(name_,methodDeclaration)
, any_LTR("_,")
                     )
, PROP(varRef_,appendToDeclaration)
, any_LTR("_")
...
//call __ModuleInit for all the imported modules. call the base modules init first
        ...
        //for each moduleNode:Grammar.Module in map project.moduleCache
        any _list67=PROP(moduleCache_,project);
        {NameValuePair_ptr __nvp=NULL; //name:value pair
        int64_t __len=MAPSIZE(_list67); //how many pairs
        var moduleNode=undefined; //value
        for(int64_t __inx=0 ; __inx < __len ; __inx++ ){
                __nvp = MAPITEM( __inx,_list67);
                moduleNode= __nvp->value;
            ...
            if(!__is(moduleNode,PROP(main_,project))){
                ...
                METHOD(push_,moduleList)(moduleList,1,(any_arr){moduleNode
                }); //order in moduleCache is lower level to higher level
        }}};// end for each in map
        ...
        any _list68=moduleList;
        { var nodeModule=undefined;
        for(int nodeModule__inx=0 ; nodeModule__inx<_list68.value.arr->length ; nodeModule__inx++){nodeModule=ITEM(nodeModule__inx,_list68);
        
            //.out '    ',nodeModule.fileInfo.base,'__moduleInit();',NL 
            METHOD(out_,this)(this,4,(any_arr){any_LTR("    ")
, PROP(base_,PROP(fileInfo_,nodeModule))
, any_LTR("__moduleInit();")
, Producer_c_NL
            });
        }};// end for each in
...
, PROP(base_,PROP(fileInfo_,PROP(main_,project)))
, any_LTR("__moduleInit();")
, Producer_c_NL
, any_LTR("\n\n    LiteC_finish();")
, Producer_c_NL
...
, Producer_c_NL
        ...
        var dispatcherFull = _concatAny(2,(Environment_getDir(undefined,1,(any_arr){PROP(outFilename_,PROP(fileInfo_,PROP(parent_,this)))
        }))
, any_LTR("/_dispatcher.h")
        );
        //var dispatcherRel = Environment.relativeFrom(thisBase,dispatcherFull)
        var dispatcherRel = Environment_relativeFrom(undefined,2,(any_arr){thisBase
, dispatcherFull
        });
        //.out '#include "', dispatcherRel, '"',NL
        METHOD(out_,this)(this,4,(any_arr){any_LTR("#include \"")
, dispatcherRel
, any_LTR("\"")
, Producer_c_NL
        });
...
//Modules have a __moduleInit function holding module items initialization and any loose statements
        ...
        METHOD(out_,this)(this,4,(any_arr){any_LTR("extern void ")
, prefix
, any_LTR("__moduleInit(void);")
, Producer_c_NL
        });
...
, any_LTR("//Module ")
, prefix
, _anyToBool(PROP(isInterface_,PROP(fileInfo_,this))) ? any_LTR(" - INTERFACE") : any_EMPTY_STR
, Producer_c_NL
, any_LTR("//-------------------------")
, Producer_c_NL
            });
        ...
        METHOD(out_,this)(this,2,(any_arr){_concatAny(3,any_LTR("#include \"")
, PROP(base_,PROP(fileInfo_,this))
, any_LTR(".c.extra\"")
        )
, Producer_c_NL
        });
        //.lexer.outCode.filenames[2] = "#{.fileInfo.outFilename}.extra"
        ITEM(2,PROP(filenames_,PROP(outCode_,PROP(lexer_,this)))) = _concatAny(2,PROP(outFilename_,PROP(fileInfo_,this))
, any_LTR(".extra")
        );
...
, Producer_c_NL
        ...
        if (_anyToBool(PROP(isInterface_,PROP(fileInfo_,this))))  { // add call to native hand-coded C support for this module
            ...
            METHOD(out_,this)(this,4,(any_arr){Producer_c_NL
, any_LTR("    ")
, prefix
, any_LTR("__nativeInit();")
            });
        };
        //.out NL,"};",NL
        METHOD(out_,this)(this,3,(any_arr){Producer_c_NL
...
, any_LTR("//helper tempvars for 'or' expressions short-circuit evaluation")
, Producer_c_NL
, any_LTR("any __or1")
            });
        ...
        for(int64_t n=2; n<=_end7; n++){
            //.out ",__or#{n}"
            METHOD(out_,this)(this,1,(any_arr){_concatAny(2,any_LTR(",__or")
, any_number(n)
            )
            });
        };// end for n
...
//Append-to body contains properties and methods definitions.
      ...
      any Grammar_AppendToDeclaration_produceHeader(DEFAULT_ARGUMENTS){
        ...
        if (_anyToBool(PROP(toNamespace_,this)))  {
            ...
            __call(produceDeclaredExternProps_,PROP(body_,this),2,(any_arr){METHOD(getComposedName_,nameDeclClass)(nameDeclClass,0,NULL)
, true
            });
...
//for each method declaration in .body
            ...
            any _list69=PROP(statements_,PROP(body_,this));
            { var item=undefined;
...
//out header
                    ...
                    METHOD(out_,this)(this,4,(any_arr){any_LTR("extern any ")
, __call(getComposedName_,PROP(nameDecl_,PROP(specific_,item)),0,NULL)
, any_LTR("(DEFAULT_ARGUMENTS);")
, Producer_c_NL
                    });
            }}};// end for each in
...
//#### method produceCallNamespaceInit()
     any Grammar_NamespaceDeclaration_produceCallNamespaceInit(DEFAULT_ARGUMENTS){
        ...
        METHOD(out_,this)(this,4,(any_arr){any_LTR("    ")
, __call(getComposedName_,PROP(nameDecl_,this),0,NULL)
, any_LTR("__namespaceInit();")
, Producer_c_NL
        });
     return undefined;
     }
...
//all namespace methods & props are public 
        ...
        any _list70=PROP(members_,PROP(nameDecl_,this));
        {NameValuePair_ptr __nvp=NULL; //name:value pair
        ...
        for(int64_t __inx=0 ; __inx < __len ; __inx++ ){
            ...
            if(!(__in(PROP(name_,member),3,(any_arr){any_LTR("constructor"), any_LTR("length"), any_LTR("prototype")}))){
                ...
                if (__is(PROP(nodeClass_,member),Grammar_VariableDecl)){
                        ...
                        METHOD(out_,this)(this,6,(any_arr){any_LTR("    extern var ")
, prefix
, any_LTR("_")
, PROP(name_,member)
, any_LTR(";")
, Producer_c_NL
                    ...
                    //when Grammar.MethodDeclaration
                        ...
                        METHOD(out_,this)(this,6,(any_arr){any_LTR("    extern any ")
, prefix
, any_LTR("_")
, PROP(name_,member)
, any_LTR("(DEFAULT_ARGUMENTS);")
, Producer_c_NL
        ...
        __call(produceDeclaredExternProps_,PROP(body_,this),2,(any_arr){prefix
, true
        });
     return undefined;
     }
...
//__namespaceInit function
        ...
        METHOD(out_,this)(this,8,(any_arr){Producer_c_NL
, Producer_c_NL
, any_LTR("//------------------")
, Producer_c_NL
, any_LTR("void ")
, prefix
, any_LTR("__namespaceInit(void){")
, Producer_c_NL
            });
...
//In C we create a struct for "instance properties" of each class 
        ...
        METHOD(out_,this)(this,10,(any_arr){any_LTR("typedef struct ")
, c
, any_LTR("_s * ")
, c
, any_LTR("_ptr;")
, Producer_c_NL
, any_LTR("typedef struct ")
, c
, any_LTR("_s {")
, Producer_c_NL
            });
...
//and declare extern for class __init
        ...
        METHOD(out_,this)(this,4,(any_arr){any_LTR("extern void ")
, c
, any_LTR("__init(DEFAULT_ARGUMENTS);")
, Producer_c_NL
        });
        //.out "extern any ",c,"_newFromObject(DEFAULT_ARGUMENTS);",NL
        METHOD(out_,this)(this,4,(any_arr){any_LTR("extern any ")
, c
, any_LTR("_newFromObject(DEFAULT_ARGUMENTS);")
, Producer_c_NL
        });
...
//methods in the class as namespace
        ...
        any _list72=PROP(members_,PROP(nameDecl_,this));
        {NameValuePair_ptr __nvp=NULL; //name:value pair
        int64_t __len=MAPSIZE(_list72); //how many pairs
        var nameDecl=undefined; //value
        for(int64_t __inx=0 ; __inx < __len ; __inx++ ){
                __nvp = MAPITEM( __inx,_list72);
                nameDecl= __nvp->value;
          
            //where nameDecl.name isnt 'prototype' and nameDecl.name.charAt(0) isnt '*'
            if(!__is(PROP(name_,nameDecl),any_LTR("prototype")) && !__is(__call(charAt_,PROP(name_,nameDecl),1,(any_arr){any_number(0)
            }),any_LTR("*"))){
...
, any_LTR("_")
, PROP(name_,nameDecl)
, any_LTR("(DEFAULT_ARGUMENTS); //class as namespace")
, Producer_c_NL
                    });
                };
        }}};// end for each in map
...
//this is the class body, goes on the .c file,
        ...
        { var item=undefined;
        for(int index=0 ; index<_list73.value.arr->length ; index++){item=ITEM(index,_list73);
...
//default constructors
        ...
        if (!(_anyToBool(PROP(isInterface_,PROP(fileInfo_,METHOD(getParent_,this)(this,1,(any_arr){Grammar_Module
            ...
            if (!(_anyToBool(hasConstructor)))  {
                ...
                METHOD(out_,this)(this,10,(any_arr){any_LTR("//auto ")
, c
, any_LTR("__init")
, Producer_c_NL
, any_LTR("void ")
...
, any_LTR("__init(this,argc,arguments);")
, Producer_c_NL
                        });
                };
                //.body.producePropertiesInitialValueAssignments '((#{c}_ptr)this.value.ptr)->'
                __call(producePropertiesInitialValueAssignments_,PROP(body_,this),1,(any_arr){_concatAny(3,any_LTR("((")
, c
, any_LTR("_ptr)this.value.ptr)->")
                )
                });
...
//produce newFromObject
            ...
            if (!(_anyToBool(hasNewFromObject)))  {
                ...
                //.out 
                    ...
                    //"}",NL
                METHOD(out_,this)(this,15,(any_arr){Producer_c_NL
, any_LTR("//auto ")
, c
, any_LTR("_newFromObject")
, Producer_c_NL
, any_LTR("inline any ")
, c
, any_LTR("_newFromObject(DEFAULT_ARGUMENTS){")
, Producer_c_NL
, any_LTR("    return _newFromObject(")
, c
, any_LTR(",argc,arguments);")
, Producer_c_NL
, any_LTR("}")
, Producer_c_NL
                    });
...
, Producer_c_NL
, _concatAny(3,any_LTR("any ")
, c
, any_LTR("; //Class ")
            )
, c
, _anyToBool(PROP(varRefSuper_,this)) ? new(Array,3,(any_arr){any_LTR(" extends "), PROP(varRefSuper_,this), Producer_c_NL}) : any_EMPTY_STR
, Producer_c_NL
            });
     return undefined;
     }
...
//static definition info for each class: list of _METHODS and _PROPS
        ...
        METHOD(out_,this)(this,13,(any_arr){any_LTR("//-----------------------")
, Producer_c_NL
, any_LTR("// Class ")
, c
, any_LTR(": static list of METHODS(verbs) and PROPS(things)")
, Producer_c_NL
, any_LTR("//-----------------------")
, Producer_c_NL
, Producer_c_NL
, any_LTR("static _methodInfoArr ")
, c
, any_LTR("_METHODS = {")
, Producer_c_NL
            });
        ...
        for(int64_t __inx=0 ; __inx < __len ; __inx++ ){
            ...
            if(!(__in(PROP(name_,nameDecl),3,(any_arr){any_LTR("constructor"), any_LTR("length"), any_LTR("prototype")}))){
                ...
                if (__is(PROP(nodeClass_,nameDecl),Grammar_MethodDeclaration))  {
                    ...
                    METHOD(out_,this)(this,2,(any_arr){_concatAny(7,any_LTR("  { ")
, (Producer_c_makeSymbolName(undefined,1,(any_arr){PROP(name_,nameDecl)
                    }))
, any_LTR(", ")
, c
, any_LTR("_")
...
, Producer_c_NL
        ...
        //.out 
            ...
            //{CSL:propList, post:'\n    '}
            //"};",NL,NL
        METHOD(out_,this)(this,12,(any_arr){Producer_c_NL
, any_LTR("{0,0}}; //method jmp table initializer end mark")
, Producer_c_NL
, Producer_c_NL
, any_LTR("static propIndex_t ")
, c
, any_LTR("_PROPS[] = {")
, Producer_c_NL
, new(Map,2,(any_arr){
...
//#### method produceClassRegistration
     any Grammar_ClassDeclaration_produceClassRegistration(DEFAULT_ARGUMENTS){
        ...
        METHOD(out_,this)(this,7,(any_arr){_concatAny(11,any_LTR("    ")
, c
, any_LTR(" =_newClass(\"")
, c
, any_LTR("\", ")
, c
, any_LTR("__init, sizeof(struct ")
, c
, any_LTR("_s), ")
, superName
, any_LTR(");")
...
, Producer_c_NL
, _concatAny(5,any_LTR("    _declareMethods(")
, c
, any_LTR(", ")
, c
, any_LTR("_METHODS);")
...
, Producer_c_NL
, _concatAny(7,any_LTR("    _declareProps(")
, c
, any_LTR(", ")
, c
, any_LTR("_PROPS, sizeof ")
, c
, any_LTR("_PROPS);")
            )
, Producer_c_NL
...
//out all properties of a class, including those of the super's-chain
        ...
        //node.out '    //',.name,NL
        METHOD(out_,node)(node,3,(any_arr){any_LTR("    //")
, PROP(name_,this)
, Producer_c_NL
        });
        ...
        if (!_anyToBool(prt)) {METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(3,any_LTR("class ")
, PROP(name_,this)
, any_LTR(" has no prototype")
        )
        });};
        //for each prtNameDecl in map prt.members
        any _list75=PROP(members_,prt);
        {NameValuePair_ptr __nvp=NULL; //name:value pair
        int64_t __len=MAPSIZE(_list75); //how many pairs
        var prtNameDecl=undefined; //value
        for(int64_t __inx=0 ; __inx < __len ; __inx++ ){
                __nvp = MAPITEM( __inx,_list75);
                prtNameDecl= __nvp->value;
            ...
            if(!(__in(PROP(name_,prtNameDecl),3,(any_arr){any_LTR("constructor"), any_LTR("length"), any_LTR("prototype")}))){
                ...
                if (__is(PROP(nodeClass_,prtNameDecl),Grammar_VariableDecl))  {
                    ...
                    METHOD(out_,node)(node,4,(any_arr){any_LTR("    any ")
, PROP(name_,prtNameDecl)
, any_LTR(";")
, Producer_c_NL
                    });
...
//#### method produce()
     any Grammar_Body_produce(DEFAULT_ARGUMENTS){
        ...
        for(int statement__inx=0 ; statement__inx<_list76.value.arr->length ; statement__inx++){statement=ITEM(statement__inx,_list76);
...
//#### method produceDeclaredExternProps(parentName,forcePublic)
     any Grammar_Body_produceDeclaredExternProps(DEFAULT_ARGUMENTS){
        ...
        if (!_anyToBool(PROP(statements_,this))) {return undefined;};
        //var prefix = parentName? "#{parentName}_" else ""
        var prefix = _anyToBool(parentName) ? _concatAny(2,parentName
, any_LTR("_")
        ) : any_EMPTY_STR;
        ...
        for(int item__inx=0 ; item__inx<_list77.value.arr->length ; item__inx++){item=ITEM(item__inx,_list77);
            ...
            if (__is(any_class(PROP(specific_,item).class),Grammar_VarStatement)){
                    ...
                    if (_anyToBool(isPublic)) {METHOD(out_,this)(this,4,(any_arr){any_LTR("extern var ")
, new(Map,2,(any_arr){
                    _newPair("pre",prefix), 
...
, Producer_c_NL
                ...
                //when Grammar.FunctionDeclaration, Grammar.MethodDeclaration //method: append to class xx - when is a core class
                    ...
                    if (_anyToBool(isPublic)) {METHOD(out_,this)(this,5,(any_arr){any_LTR("extern any ")
, prefix
, PROP(name_,PROP(specific_,item))
, any_LTR("(DEFAULT_ARGUMENTS);")
, Producer_c_NL
                    });};
...
, new(Map,2,(any_arr){
                _newPair("pre",_concatAny(2,prefix
, any_LTR("_")
                )), 
                _newPair("CSL",__call(getNames_,PROP(specific_,item),0,NULL))
                })
...
, Producer_c_NL
            ...
            //else if item.specific.constructor is Grammar.FunctionDeclaration
                ...
                METHOD(out_,this)(this,6,(any_arr){any_LTR("any ")
, prefix
, any_LTR("_")
, PROP(name_,PROP(specific_,item))
, any_LTR("(DEFAULT_ARGUMENTS); //forward declare")
, Producer_c_NL
                });
            ...
            //else if item.specific.constructor is Grammar.AppendToDeclaration
                ...
                __call(callOnSubTree_,PROP(specific_,item),1,(any_arr){LiteCore_getSymbol(undefined,1,(any_arr){any_LTR("produceStaticListMethodsAndProps")
                })
                }); //if there are internal classes
                //produceThird.push item
                METHOD(push_,produceThird)(produceThird,1,(any_arr){item
                });
            }
...
//User classes must be registered previously, in case the module vars use them as initial values.
        //for each item in .statements 
        any _list81=PROP(statements_,this);
        { var item=undefined;
        for(int item__inx=0 ; item__inx<_list81.value.arr->length ; item__inx++){item=ITEM(item__inx,_list81);
            ...
            if(_instanceof(PROP(specific_,item),Grammar_VarDeclList)){
                ...
                any _list82=PROP(list_,PROP(specific_,item));
                { var variableDecl=undefined;
                for(int variableDecl__inx=0 ; variableDecl__inx<_list82.value.arr->length ; variableDecl__inx++){variableDecl=ITEM(variableDecl__inx,_list82);
...
, prefix
, any_LTR("_")
, PROP(name_,variableDecl)
, any_LTR(" = ")
, PROP(assignedValue_,variableDecl)
, any_LTR(";")
, Producer_c_NL
                        });
                }}};// end for each in
...
//if there is var or properties with assigned values, produce those assignment
        //for each item in .statements 
        any _list83=PROP(statements_,this);
        { var item=undefined;
        for(int item__inx=0 ; item__inx<_list83.value.arr->length ; item__inx++){item=ITEM(item__inx,_list83);
            ...
            if(__is(any_class(PROP(specific_,item).class),Grammar_PropertiesDeclaration)){
                ...
                //for each variableDecl in item.specific.list
                any _list84=PROP(list_,PROP(specific_,item));
                { var variableDecl=undefined;
                for(int variableDecl__inx=0 ; variableDecl__inx<_list84.value.arr->length ; variableDecl__inx++){variableDecl=ITEM(variableDecl__inx,_list84);
                  
                    //where variableDecl.assignedValue
                    if(_anyToBool(PROP(assignedValue_,variableDecl))){
                        //.out 'PROP(',variableDecl.name,'_,this)=',variableDecl.assignedValue,";",NL
                        METHOD(out_,this)(this,6,(any_arr){any_LTR("PROP(")
, PROP(name_,variableDecl)
, any_LTR("_,this)=")
, PROP(assignedValue_,variableDecl)
, any_LTR(";")
...
//declare vars before the statement (exclude body of FunctionDeclaration)
        ...
        METHOD(callOnSubTree_,this)(this,2,(any_arr){LiteCore_getSymbol(undefined,1,(any_arr){any_LTR("declareIntoVar")
        })
, Grammar_Body
        });
...
//### append to class Grammar.ThrowStatement ###
      ...
      any Grammar_ThrowStatement_produce(DEFAULT_ARGUMENTS){
          ...
          if (__is(PROP(specifier_,this),any_LTR("fail")))  {
            ...
            METHOD(out_,this)(this,3,(any_arr){any_LTR("throw(new(Error,1,(any_arr){")
, PROP(expr_,this)
, any_LTR("}));")
            });
          }
          //else
            ...
            //.out "throw(",.expr,")"
            METHOD(out_,this)(this,3,(any_arr){any_LTR("throw(")
, PROP(expr_,this)
, any_LTR(")")
            });
          };
...
//### Append to class Grammar.ReturnStatement ###
      ...
      any Grammar_ReturnStatement_produce(DEFAULT_ARGUMENTS){
        ...
        var defaultReturn = _anyToBool(METHOD(getParent_,this)(this,1,(any_arr){Grammar_ConstructorDeclaration
        })) ? any_EMPTY_STR : any_LTR("undefined");
...
//because an auto "try{" is inserted at function start
        ...
        if (_anyToBool(countTryBlocks))  {
            ...
            METHOD(out_,this)(this,3,(any_arr){any_LTR("{e4c_exitTry(")
, countTryBlocks
, any_LTR(");")
            });
        };
...
, (_anyToBool(__or10=PROP(expr_,this))? __or10 : defaultReturn)
        });
        //if countTryBlocks
        if (_anyToBool(countTryBlocks))  {
            //.out ";}"
...
//or the only Operand of a unary oper.
      ...
      any Grammar_Operand_produce(DEFAULT_ARGUMENTS){
        ...
        if (_instanceof(PROP(name_,this),Grammar_StringLiteral))  {
            ...
            if (__is(METHOD(charAt_,strValue)(strValue,1,(any_arr){any_number(0)
            }),any_LTR("'")))  {
                ...
                strValue = METHOD(replaceAll_,strValue)(strValue,2,(any_arr){any_LTR("\"")
, any_LTR("\\\"")
                }); // escape internal " => \"
                //strValue = '"#{strValue}"' // enclose in ""
                strValue = _concatAny(3,any_LTR("\"")
, strValue
, any_LTR("\"")
                ); // enclose in ""
            };
            ...
            else if (__is(PROP(produceType_,this),any_LTR("Number")) && (_anyToBool((_anyToBool(__or11=any_number(__is(any_number(_length(strValue)),any_number(3))))? __or11 : any_number(__is(METHOD(charAt_,strValue)(strValue,1,(any_arr){any_number(1)
            }),any_LTR("/")) && __is(any_number(_length(strValue)),any_number(4)))))))  { //a single char (maybe escaped)
                //.out "'", strValue.slice(1,-1), "'" // out as C 'char' (C char = byte, a numeric value)
                METHOD(out_,this)(this,3,(any_arr){any_LTR("'")
, METHOD(slice_,strValue)(strValue,2,(any_arr){any_number(1)
, any_number(-1)
                })
, any_LTR("'")
                }); // out as C 'char' (C char = byte, a numeric value)
            }
            //else
            
            else {
                //.out "any_LTR(",strValue,")"
                METHOD(out_,this)(this,3,(any_arr){any_LTR("any_LTR(")
, strValue
, any_LTR(")")
                });
            };
        ...
        //else if .name instance of Grammar.NumberLiteral
            ...
            METHOD(out_,this)(this,4,(any_arr){pre
, PROP(name_,this)
...
//Special cases
        ...
        if (__is(translated,any_LTR("new")) && _instanceof(PROP(name_,PROP(right_,this)),Grammar_VariableRef))  {
            ...
            METHOD(out_,this)(this,2,(any_arr){any_LTR("new(")
, __call(calcReference_,PROP(name_,PROP(right_,this)),1,(any_arr){true
            })
            });
            //return
            return undefined;
...
////            if /\w/.test(translated), translated+=" "
        ...
        METHOD(out_,this)(this,6,(any_arr){pre
, translated
, prepend
, PROP(right_,this)
, append
...
//e.g.: DO NOT: `stra+": "+strb`   DO: `"#{stra}: #{strb}"`
        ...
        if (__is(oper,any_LTR("+")))  {
            ...
            if (_anyToBool((_anyToBool(__or12=(any_number(_anyToBool(lresultNameDecl) && _anyToBool(METHOD(hasProto_,lresultNameDecl)(lresultNameDecl,1,(any_arr){any_LTR("String")
            })))))? __or12 : (any_number(_anyToBool(rresultNameDecl) && _anyToBool(METHOD(hasProto_,rresultNameDecl)(rresultNameDecl,1,(any_arr){any_LTR("String")
                })))))))  {
...
//example: `char not in myString` -> `indexOf(char,myString)==-1`
        ...
        if (__is(PROP(name_,this),any_LTR("in"))){
            ...
            if (_instanceof(PROP(name_,PROP(right_,this)),Grammar_ArrayLiteral))  {
                ...
                METHOD(out_,this)(this,11,(any_arr){toAnyPre
, prepend
, any_LTR("__in(")
, PROP(left_,this)
, any_LTR(",")
, any_number(_length(PROP(items_,haystack)))
, any_LTR(",(any_arr){")
, new(Map,1,(any_arr){
...
, toAnyPost
            ...
            //else
                ...
                METHOD(out_,this)(this,8,(any_arr){toAnyPre
, any_LTR("CALL1(indexOf_,")
, PROP(right_,this)
, any_LTR(",")
, PROP(left_,this)
, any_LTR(").value.number")
...
, toAnyPost
          ...
          //when 'has property'
            ...
            METHOD(out_,this)(this,9,(any_arr){toAnyPre
, prepend
, any_LTR("_hasProperty(")
, PROP(left_,this)
, any_LTR(",")
, PROP(right_,this)
, any_LTR(")")
...
, toAnyPost
          ...
          //when 'into'
            ...
            if (_anyToBool(PROP(produceType_,this)) && !__is(PROP(produceType_,this),any_LTR("any"))) {METHOD(out_,this)(this,3,(any_arr){any_LTR("_anyTo")
, PROP(produceType_,this)
, any_LTR("(")
            });};
...
, toAnyPost
          ...
          //when 'is'
            ...
            METHOD(out_,this)(this,8,(any_arr){toAnyPre
, _anyToBool(PROP(negated_,this)) ? any_LTR("!") : any_EMPTY_STR
, any_LTR("__is(")
, PROP(left_,this)
, any_LTR(",")
, PROP(right_,this)
...
, toAnyPost
          ...
          //when 'or'
            ...
            var orTmp = _concatAny(2,any_LTR("__or")
, PROP(orTempVarCount_,PROP(outCode_,PROP(lexer_,this)))
            );
            //.left.produceType = 'any'
            PROP(produceType_,PROP(left_,this)) = any_LTR("any");
            //.right.produceType = 'any'
...
, any_LTR("(")
            ...
            METHOD(out_,this)(this,5,(any_arr){_concatAny(3,any_LTR("(_anyToBool(")
, orTmp
, any_LTR("=")
            )
, PROP(left_,this)
...
, any_LTR(")")
          ...
          //when '%',"<<",">>","bitand","bitor","bitxor"
        else if (__is(PROP(name_,this),any_LTR("%"))||__is(PROP(name_,this),any_LTR("<<"))||__is(PROP(name_,this),any_LTR(">>"))||__is(PROP(name_,this),any_LTR("bitand"))||__is(PROP(name_,this),any_LTR("bitor"))||__is(PROP(name_,this),any_LTR("bitxor"))){
            ...
            METHOD(out_,this)(this,6,(any_arr){any_LTR("(int64_t)")
, PROP(left_,this)
, any_LTR(" ")
, Producer_c_operTranslate(undefined,1,(any_arr){oper
            })
, any_LTR(" (int64_t)")
, PROP(right_,this)
            });
          ...
          //when '&'
            ...
            METHOD(out_,this)(this,5,(any_arr){any_LTR("_concatAny(2,")
, PROP(left_,this)
, any_LTR(",")
, PROP(right_,this)
, any_LTR(")")
            ...
            if (!__is(operC,any_LTR("?")))  { // cant put xx( a ? b )
                ...
                //else if .produceType 
                    ...
                    //else
                      ...
                      preExtra = _concatAny(3,any_LTR("_anyTo")
, PROP(produceType_,this)
, any_LTR("(")
                      );
                      //extra = ")"
            ...
            METHOD(out_,this)(this,9,(any_arr){preExtra
, prepend
, PROP(left_,this)
, any_LTR(" ")
, operC
...
//Prefix ++/--, varName, Accessors and postfix ++/--
        ...
        //else if .produceType and .produceType isnt 'any' and .calcType is 'any'
            ...
            pre = _concatAny(3,any_LTR("_anyTo")
, PROP(produceType_,this)
, any_LTR("(")
            );
            //post = ')'
        ...
        //.out pre, result, post
        METHOD(out_,this)(this,3,(any_arr){pre
, result
, post
        });
      return undefined;
...
//Start with main variable name, to check property names
        ...
        if (!_anyToBool(actualVar)) {METHOD(throwError_,this)(this,1,(any_arr){_concatAny(3,any_LTR("var '")
, PROP(name_,this)
, any_LTR("' not found in scope")
        )
        });};
        ...
        if (__is(METHOD(findOwnMember_,actualVar)(actualVar,1,(any_arr){any_LTR("**proto**")
        }),any_LTR("**native number**"))) {PROP(calcType_,this) = any_LTR("**native number**");};
...
//now follow each accessor
        ...
        any _list86=PROP(accessors_,this);
        { var ac=undefined;
        for(int inx=0 ; inx<_list86.value.arr->length ; inx++){ac=ITEM(inx,_list86);
            ...
            if (_instanceof(ac,Grammar_PropertyAccess))  {
                ...
                //else if ac.name is 'prototype' //hack, all classes have a "prototype" to access methods
                    ...
                    //else
                        ...
                        METHOD(unshift_,classNameArr)(classNameArr,3,(any_arr){any_LTR("__classMethodFunc(")
, PROP(name_,ITEM(inx + 1,PROP(accessors_,this)))
, any_LTR("_ ,")
                        }); //__classMethodFunc(methodName,
                        //// here goes any class
                        //classNameArr.push ")"
                        METHOD(push_,classNameArr)(classNameArr,1,(any_arr){any_LTR(")")
                        });
                        //result.push classNameArr //now converted to any Function
                        METHOD(push_,result)(result,1,(any_arr){classNameArr
                        }); //now converted to any Function
                ...
                //else if ac.name is 'length' //hack, convert x.length in a funcion call, _length(x)
                    ...
                    METHOD(unshift_,result)(result,1,(any_arr){new(Array,2,(any_arr){any_LTR("_length"), any_LTR("(")})
                    }); // put "length(" first - call to dispatcher
                    //result.push [")"]
                ...
                //else if ac.name is 'call' 
                    ...
                    METHOD(addArguments_,this)(this,2,(any_arr){METHOD(slice_,args)(args,1,(any_arr){any_number(1)
                    })
, FnArr
                    }); //other arguments
                    //FnArr.push ')'
                ...
                //else if actualVar and (actualVar.nodeClass is Grammar.NamespaceDeclaration or actualVar.findOwnMember('prototype'))
                    ...
                    METHOD(push_,prevArr)(prevArr,2,(any_arr){any_LTR("_")
, PROP(name_,ac)
                    });
                    //result.push prevArr
                ...
                //else
                    ...
                    METHOD(unshift_,result)(result,1,(any_arr){new(Array,4,(any_arr){any_LTR("PROP"), any_LTR("("), Producer_c_makeSymbolName(undefined,1,(any_arr){PROP(name_,ac)
                    }), any_LTR(",")})
                    }); // PROP macro enclose all
...
, any_LTR("(...)")
                ...
                if (inx > 1 && !__is(any_class(ITEM(inx - 1,PROP(accessors_,this)).class),Grammar_PropertyAccess))  {
                    ...
                    METHOD(throwError_,this)(this,1,(any_arr){_concatAny(3,any_LTR("'")
, partial
, any_LTR(".call' or '.apply' must be used to call a function pointer stored in a variable")
                    )
                });
                };
                ...
                if (_anyToBool(callNew))  {
                    ...
                    METHOD(addArguments_,this)(this,2,(any_arr){PROP(args_,functionAccess)
, callParams
                    });
                    //callParams.push ")" //close 
                    METHOD(push_,callParams)(callParams,1,(any_arr){any_LTR(")")
                    }); //close
                }
                //else
                    ...
                    if (!_anyToBool(hasInstanceReference))  { //first accessor is function access, this is a call to a global function
                        ...
                        }); // put "functioname" first - call to global function
                        ...
                        if (__is(ITEM(0,fnNameArray),any_LTR("_concatAny")))  {
                            ...
                            METHOD(addArguments_,this)(this,3,(any_arr){PROP(args_,functionAccess)
, callParams
, true
                            });
                        }
...
, callParams
                        ...
                        METHOD(push_,callParams)(callParams,1,(any_arr){any_LTR(")")
                        }); //close function(undefined,arg,any* arguments)
                    }
                    //else
                        ...
                        if (_anyToBool(false))  { //functionAccess.args and functionAccess.args.length<=4
                            ...
                            METHOD(unshift_,fnNameArray)(fnNameArray,1,(any_arr){_concatAny(3,any_LTR("CALL")
, any_number(_length(PROP(args_,functionAccess)))
, any_LTR("(")
                            )
                            });
                            ...
                            METHOD(unshift_,result)(result,1,(any_arr){fnNameArray
                            }); //prepend CALLn(method_,instanceof,...
                        ...
                        //else // do not use macros CALL1 to CALL4
                            ...
                            if (_anyToBool(simpleVar))  {
                                ...
                                METHOD(push_,result)(result,1,(any_arr){new(Array,2,(any_arr){any_LTR(")("), simpleVarName})
                                }); // METHOD(symbol_,this)(this
                                ////options.validations.push ["assert("].concat(callParams,".type>TYPE_NULL);")
                                //callParams = [","]
                            ...
                            //else
                                ...
                                //result.unshift fnNameArray //prepend __call(methodName, ...instanceof
                                METHOD(unshift_,result)(result,1,(any_arr){fnNameArray
                                }); //prepend __call(methodName, ...instanceof
                                ////options.validations.push ["assert("].concat(callParams,".type>TYPE_NULL);")
                                //callParams = [","]
                                callParams = new(Array,1,(any_arr){any_LTR(",")});
                            };
...
, any_LTR("[...]")
      ...
      any Grammar_VariableRef_addArguments(DEFAULT_ARGUMENTS){
        ...
        if (_anyToBool(args) && _length(args))  {
            ...
            METHOD(push_,callParams)(callParams,4,(any_arr){_concatAny(2,any_number(_length(args))
, any_LTR(",")
            )
, pre
, new(Map,2,(any_arr){
...
//### append to class Grammar.AssignmentStatement ###
      ...
      any Grammar_AssignmentStatement_produce(DEFAULT_ARGUMENTS){
        ...
        if (_anyToBool((nameDecl=__call(tryGetReference_,PROP(lvalue_,this),0,NULL))) && __is(METHOD(findOwnMember_,nameDecl)(nameDecl,1,(any_arr){any_LTR("**proto**")
            }),any_LTR("**native number**")))  {
        ...
        if (__is(oper,any_LTR("+="))||__is(oper,any_LTR("-="))||__is(oper,any_LTR("*="))||__is(oper,any_LTR("/="))){
                ...
                METHOD(out_,this)(this,6,(any_arr){PROP(lvalue_,this)
, extraLvalue
, any_LTR(" ")
, oper
, any_LTR(" ")
, PROP(rvalue_,this)
            ...
            //when "&=" //string concat
                ...
                METHOD(out_,this)(this,7,(any_arr){PROP(lvalue_,this)
, any_LTR("=")
, any_LTR("_concatAny(2,")
, PROP(lvalue_,this)
, any_LTR(",")
, PROP(rvalue_,this)
, any_LTR(")")
...
, any_LTR(" ")
, Producer_c_operTranslate(undefined,1,(any_arr){PROP(name_,this)
                })
, any_LTR(" ")
, PROP(rvalue_,this)
                });
      ...
      any Names_Declaration_addToAllProperties(DEFAULT_ARGUMENTS){
        ...
        if (CALL1(indexOf_,Producer_c_coreSupportedProps,name).value.number==-1 && !(_anyToBool(METHOD(has_,Producer_c_allPropertyNames)(Producer_c_allPropertyNames,1,(any_arr){name
            ...
            if (_anyToBool(METHOD(has_,Producer_c_allMethodNames)(Producer_c_allMethodNames,1,(any_arr){name
                ...
                METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(3,any_LTR("Ambiguity: A method named '")
, name
, any_LTR("' is already defined. Cannot reuse the symbol for a property")
                )
                });
                //allMethodNames.get(name).sayErr "declaration of method '#{name}'"
                __call(sayErr_,METHOD(get_,Producer_c_allMethodNames)(Producer_c_allMethodNames,1,(any_arr){name
                }),1,(any_arr){_concatAny(3,any_LTR("declaration of method '")
, name
, any_LTR("'")
                )
                });
            ...
            //else if name in coreSupportedMethods
                ...
                METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(3,any_LTR("'")
, name
, any_LTR("' is declared in as a core method. Cannot use the symbol for a property")
                )
                });
            }
            //else
                ...
                METHOD(set_,Producer_c_allPropertyNames)(Producer_c_allPropertyNames,2,(any_arr){name
, this
                });
            };
        };
...
//### Append to class Grammar.VarDeclList ###
      ...
      any Grammar_VarDeclList_getNames(DEFAULT_ARGUMENTS){
        ...
        //for each varDecl in .list
        any _list88=PROP(list_,this);
        { var varDecl=undefined;
        for(int varDecl__inx=0 ; varDecl__inx<_list88.value.arr->length ; varDecl__inx++){varDecl=ITEM(varDecl__inx,_list88);
...
//'var' followed by a list of comma separated: var names and optional assignment
      ...
      any Grammar_VarStatement_produce(DEFAULT_ARGUMENTS){
        ...
        //---------
        //.out 'var ',{CSL:.list}
        METHOD(out_,this)(this,2,(any_arr){any_LTR("var ")
, new(Map,1,(any_arr){
...
, any_LTR(" = ")
, (_anyToBool(__or19=PROP(assignedValue_,this))? __or19 : any_LTR("undefined"))
        });
      return undefined;
      }
...
//### Append to class Grammar.SingleLineBody ###
      ...
      any Grammar_SingleLineBody_produce(DEFAULT_ARGUMENTS){
        ...
        //for each item in .statements
        any _list89=PROP(statements_,this);
        { var item=undefined;
        for(int item__inx=0 ; item__inx<_list89.value.arr->length ; item__inx++){item=ITEM(item__inx,_list89);
...
//Create a default index var name if none was provided
        ...
        METHOD(out_,this)(this,2,(any_arr){any_LTR("{")
, Producer_c_NL
        }); //enclose defined temp vars in their own scope
        //var listName, uniqueName = UniqueID.getVarName('list')  #unique temp listName var name
        var listName = undefined, uniqueName = UniqueID_getVarName(undefined,1,(any_arr){any_LTR("list")
        });// #unique temp listName var name
...
//create a var holding object property count
        ...
        METHOD(out_,this)(this,4,(any_arr){any_LTR("len_t __propCount=_length(")
, listName
, any_LTR(");")
, Producer_c_NL
        });
        ...
        var intIndexVarName = _concatAny(2,PROP(name_,PROP(mainVar_,this))
, any_LTR("__inx")
        );
        //if .indexVar 
        if (_anyToBool(PROP(indexVar_,this)))  {
            //.out "any ",.indexVar.name,"=undefined;",NL
            METHOD(out_,this)(this,4,(any_arr){any_LTR("any ")
...
, Producer_c_NL
        ...
        //.out 
            ...
            //" ; __propIndex++ ){"
        METHOD(out_,this)(this,4,(any_arr){any_LTR("for(int __propIndex=")
, startValue
, any_LTR(" ; __propIndex < __propCount")
, any_LTR(" ; __propIndex++ ){")
            });
        //.body.out .mainVar.name,"=",listName,".value.prop[__propIndex];",NL
        __call(out_,PROP(body_,this),5,(any_arr){PROP(name_,PROP(mainVar_,this))
, any_LTR("=")
, listName
, any_LTR(".value.prop[__propIndex];")
, Producer_c_NL
        });
        ...
        if (_anyToBool(PROP(indexVar_,this)))  {
            ...
            __call(out_,PROP(body_,this),5,(any_arr){PROP(name_,PROP(indexVar_,this))
, any_LTR("= _getPropertyNameAtIndex(")
, listName
, any_LTR(",__propIndex);")
, Producer_c_NL
            });
...
//Create a default index var name if none was provided
        ...
        listName = UniqueID_getVarName(undefined,1,(any_arr){any_LTR("list")
        });// #unique temp listName var name
        //.out "any ",listName,"=",.iterable,";",NL
        METHOD(out_,this)(this,6,(any_arr){any_LTR("any ")
, listName
...
, Producer_c_NL
        ...
        if (_anyToBool(PROP(indexVar_,this)))  {
            ...
            __call(set_,PROP(members_,PROP(nameDecl_,PROP(indexVar_,this))),2,(any_arr){any_LTR("**proto**")
, any_LTR("**native number**")
            });
        ...
        //else
            ...
            intIndexVarName = _concatAny(2,PROP(name_,PROP(mainVar_,this))
, any_LTR("__inx")
            );
        };
...
, Producer_c_NL
        ...
        //.out 
            ...
            //" ; ",intIndexVarName,"++){"
        METHOD(out_,this)(this,12,(any_arr){any_LTR("for(int ")
, intIndexVarName
, any_LTR("=")
, startValue
, any_LTR(" ; ")
...
, any_LTR("}")
        ...
        METHOD(out_,this)(this,3,(any_arr){any_LTR("}};")
, new(Map,1,(any_arr){
        _newPair("COMMENT",any_LTR("end for each in"))
        })
...
//####  method produceForMap(listName)
      any Grammar_ForEachInArray_produceForMap(DEFAULT_ARGUMENTS){
        ...
        METHOD(out_,this)(this,7,(any_arr){any_LTR("{")
, any_LTR("NameValuePair_ptr __nvp=NULL; //name:value pair")
, Producer_c_NL
, any_LTR("int64_t __len=MAPSIZE(")
, listName
, any_LTR("); //how many pairs")
, Producer_c_NL
            });
            
        //if .indexVar, .out "var ",.indexVar.name,"=undefined; //key",NL 
        if (_anyToBool(PROP(indexVar_,this))) {METHOD(out_,this)(this,4,(any_arr){any_LTR("var ")
, PROP(name_,PROP(indexVar_,this))
, any_LTR("=undefined; //key")
, Producer_c_NL
        });};
        //.out "var ",.mainVar.name,"=undefined; //value",NL
        METHOD(out_,this)(this,4,(any_arr){any_LTR("var ")
, PROP(name_,PROP(mainVar_,this))
, any_LTR("=undefined; //value")
, Producer_c_NL
        });
        //.out 
            //"for(int64_t __inx=0"
            //" ; __inx < __len"
            //" ; __inx++ ){",NL
        METHOD(out_,this)(this,4,(any_arr){any_LTR("for(int64_t __inx=0")
, any_LTR(" ; __inx < __len")
, any_LTR(" ; __inx++ ){")
, Producer_c_NL
            });
        //.body.out "__nvp = MAPITEM( __inx,",listName,");",NL //get nv pair ptr
        __call(out_,PROP(body_,this),4,(any_arr){any_LTR("__nvp = MAPITEM( __inx,")
, listName
, any_LTR(");")
, Producer_c_NL
        }); //get nv pair ptr
        //if .indexVar, .body.out .indexVar.name,"= __nvp->name;",NL //get key
        if (_anyToBool(PROP(indexVar_,this))) {__call(out_,PROP(body_,this),3,(any_arr){PROP(name_,PROP(indexVar_,this))
, any_LTR("= __nvp->name;")
, Producer_c_NL
        });};
        //.body.out .mainVar.name,"= __nvp->value;",NL //get value
        __call(out_,PROP(body_,this),3,(any_arr){PROP(name_,PROP(mainVar_,this))
, any_LTR("= __nvp->value;")
, Producer_c_NL
        }); //get value
        //if .where 
...
, any_LTR("}")
        ...
        METHOD(out_,this)(this,3,(any_arr){any_LTR("}};")
, new(Map,1,(any_arr){
        _newPair("COMMENT",any_LTR("end for each in map"))
        })
...
, Producer_c_NL
        ...
        METHOD(out_,this)(this,5,(any_arr){any_LTR("for(int64_t ")
, PROP(name_,PROP(indexVar_,this))
, any_LTR("=")
, (_anyToBool(__or23=PROP(assignedValue_,PROP(indexVar_,this)))? __or23 : any_LTR("0"))
, any_LTR("; ")
        });
        //if isToDownTo
...
//if we have a post-condition, for example: `do ... loop while x>0`, 
            //.out 
                ...
                //.body
                //"} while ("
            METHOD(out_,this)(this,4,(any_arr){any_LTR("do{")
, METHOD(getEOLComment_,this)(this,0,NULL)
, PROP(body_,this)
, any_LTR("} while (")
                });
...
//### Append to class Grammar.DoNothingStatement ###
      ...
      any Grammar_DoNothingStatement_produce(DEFAULT_ARGUMENTS){
        ...
        //---------
        //.out "//do nothing",NL
        METHOD(out_,this)(this,2,(any_arr){any_LTR("//do nothing")
, Producer_c_NL
        });
      return undefined;
      }
...
//On js we just pass this through, on C we create the array on the fly
      ...
      any Grammar_ArrayLiteral_produce(DEFAULT_ARGUMENTS){
        ...
        //else
            ...
            METHOD(out_,this)(this,4,(any_arr){any_number(_length(PROP(items_,this)))
, any_LTR(",(any_arr){")
, new(Map,1,(any_arr){
      ...
      any Grammar_ObjectLiteral_produce(DEFAULT_ARGUMENTS){
        ...
        //else
            ...
            //.out 
                ...
                //{CSL:.items}
                //NL,"}"
            METHOD(out_,this)(this,5,(any_arr){any_number(_length(PROP(items_,this)))
, any_LTR(",(any_arr){")
, new(Map,1,(any_arr){
                _newPair("CSL",PROP(items_,this))
                })
...
//### Append to class Grammar.RegExpLiteral ###
      ...
      //method produce()
      any Grammar_RegExpLiteral_produce(DEFAULT_ARGUMENTS){
        ...
        METHOD(throwError_,this)(this,1,(any_arr){any_LTR("generating C-code for RegExp Literals not supported yet. Use PMREX paliatives")
        });
      return undefined;
      }
...
//Produce a Constructor
      ...
      any Grammar_ConstructorDeclaration_produce(DEFAULT_ARGUMENTS){
        ...
        METHOD(out_,this)(this,4,(any_arr){any_LTR("void ")
, c
, any_LTR("__init(DEFAULT_ARGUMENTS){")
, Producer_c_NL
        });
...
, Producer_c_NL
, any_LTR("  ")
, PROP(varRefSuper_,ownerClassDeclaration)
, any_LTR("__init(this,argc,arguments);")
, Producer_c_NL
                });
        };
...
//Initialize (non-undefined) properties with assigned values.
        ...
        __call(producePropertiesInitialValueAssignments_,PROP(body_,METHOD(getParent_,this)(this,1,(any_arr){Grammar_ClassDeclaration
        })),1,(any_arr){_concatAny(2,c
, any_LTR("_")
        )
        });
...
, Producer_c_NL
        ...
        if (_anyToBool(isClass))  {
            //.body.out 
                ...
                //"//---------"
            __call(out_,PROP(body_,this),5,(any_arr){any_LTR("assert(_instanceof(this,")
, c
, any_LTR("));")
, Producer_c_NL
, any_LTR("//---------")
...
, PROP(name_,this)
        ...
        METHOD(out_,this)(this,3,(any_arr){any_LTR("any ")
, name
, any_LTR("(DEFAULT_ARGUMENTS){")
        });
...
//start body
        ...
        if (_anyToBool(PROP(paramsDeclarations_,this)) && _length(PROP(paramsDeclarations_,this)))  {
                ...
                __call(out_,PROP(body_,this),3,(any_arr){Producer_c_NL
, any_LTR("// define named params")
, Producer_c_NL
                });
                ...
                if (__is(any_number(_length(PROP(paramsDeclarations_,this))),any_number(1)))  {
                    ...
                    __call(out_,PROP(body_,this),4,(any_arr){any_LTR("var ")
, PROP(name_,ITEM(0,PROP(paramsDeclarations_,this)))
, any_LTR("= argc? arguments[0] : undefined;")
, Producer_c_NL
                    });
                }
                //else
                    ...
                    any _list90=PROP(paramsDeclarations_,this);
                    { var paramDecl=undefined;
                    for(int paramDecl__inx=0 ; paramDecl__inx<_list90.value.arr->length ; paramDecl__inx++){paramDecl=ITEM(paramDecl__inx,_list90);
                    ...
                    //.body.out  
                        ...
                        //"switch(argc){",NL 
                    __call(out_,PROP(body_,this),9,(any_arr){any_LTR("var ")
, new(Map,1,(any_arr){
...
, any_LTR(";")
, Producer_c_NL
, METHOD(join_,namedParams)(namedParams,1,(any_arr){any_LTR("=")
                        })
, any_LTR("=undefined;")
, Producer_c_NL
, any_LTR("switch(argc){")
, Producer_c_NL
                    ...
                    for(int64_t inx=_length(namedParams) - 1; inx >= 0; inx--){
                        ...
                        __call(out_,PROP(body_,this),2,(any_arr){_concatAny(7,any_LTR("  case ")
, (any_number(inx + 1))
, any_LTR(":")
, (ITEM(inx,namedParams))
, any_LTR("=arguments[")
, any_number(inx)
, any_LTR("];")
                        )
, Producer_c_NL
                    ...
                    //.body.out "}",NL
                    __call(out_,PROP(body_,this),2,(any_arr){any_LTR("}")
, Producer_c_NL
                    });
                };
                //end if
...
//if it has a exception block, insert 'try{'
            ...
            if (_anyToBool(PROP(hasExceptionBlock_,this))) {__call(out_,PROP(body_,this),2,(any_arr){any_LTR(" try{")
, Producer_c_NL
            });};
...
//if you dot not insert a "return", the C function will return garbage.
            ...
            if (!(__is(any_class(this.class),Grammar_ConstructorDeclaration)))  { // declared as void Class__init(...)
                ...
                METHOD(out_,this)(this,2,(any_arr){any_LTR("return undefined;")
, Producer_c_NL
                });
            };
        };
...
//`print` is an alias for console.log
      ...
      any Grammar_PrintStatement_produce(DEFAULT_ARGUMENTS){
        ...
        if (_length(PROP(args_,this)))  {
            ...
            METHOD(out_,this)(this,3,(any_arr){_concatAny(3,any_LTR("print(")
, any_number(_length(PROP(args_,this)))
, any_LTR(",(any_arr){")
            )
, new(Map,1,(any_arr){
...
//### Append to class Grammar.ImportStatementItem ###
        ...
        any Grammar_ImportStatementItem_getRefFilename(DEFAULT_ARGUMENTS){
            ...
            return Environment_relativeFrom(undefined,2,(any_arr){PROP(outDir_,PROP(fileInfo_,thisModule))
, __call(outWithExtension_,PROP(fileInfo_,PROP(importedModule_,this)),1,(any_arr){any_LTR(".h")
                     })
            });
        return undefined;
        }
...
//For C production, we're declaring each distinct method name (verbs)
            ...
            if (CALL1(indexOf_,Producer_c_coreSupportedMethods,methodName).value.number==-1 && !(_anyToBool(METHOD(has_,Producer_c_allMethodNames)(Producer_c_allMethodNames,1,(any_arr){methodName
                ...
                if (_anyToBool(METHOD(has_,Producer_c_allPropertyNames)(Producer_c_allPropertyNames,1,(any_arr){methodName
                    ...
                    METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(3,any_LTR("Ambiguity: A property '")
, methodName
, any_LTR("' is already defined. Cannot reuse the symbol for a method.")
                    )
                    });
                    //allPropertyNames.get(methodName).sayErr "Definition of property '#{methodName}'."
                    __call(sayErr_,METHOD(get_,Producer_c_allPropertyNames)(Producer_c_allPropertyNames,1,(any_arr){methodName
                    }),1,(any_arr){_concatAny(3,any_LTR("Definition of property '")
, methodName
, any_LTR("'.")
                    )
                    });
                ...
                //else if methodName in coreSupportedProps
                    ...
                    METHOD(sayErr_,this)(this,1,(any_arr){_concatAny(3,any_LTR("Ambiguity: A property '")
, methodName
, any_LTR("' is defined in core. Cannot reuse the symbol for a method.")
                    )
                    });
                }
                //else
                    ...
                    METHOD(set_,Producer_c_allMethodNames)(Producer_c_allMethodNames,2,(any_arr){methodName
, this
                    });
                };
            };
...
//else body
        ...
        if (_anyToBool(PROP(elseBody_,this))) {METHOD(out_,this)(this,4,(any_arr){Producer_c_NL
, any_LTR("else {")
, PROP(elseBody_,this)
, any_LTR("}")
        });};
...
, Producer_c_NL
        ...
        //for each index,whenSection in .cases
        any _list92=PROP(cases_,this);
        { var whenSection=undefined;
        for(int index=0 ; index<_list92.value.arr->length ; index++){whenSection=ITEM(index,_list92);
...
//Check location
        ...
        if (_anyToBool((_anyToBool(__or27=any_number(!(_anyToBool((functionDeclaration=METHOD(getParent_,this)(this,1,(any_arr){Grammar_FunctionDeclaration
        }))))))? __or27 : any_number(!_anyToBool(METHOD(hasAdjective_,functionDeclaration)(functionDeclaration,1,(any_arr){any_LTR("nice")
            }))))))  {
...
, any_LTR("'")
                ...
                thisValue = METHOD(concat_,thisValue)(thisValue,1,(any_arr){__call(slice_,PROP(accessors_,varRef),2,(any_arr){any_number(0)
, inx
                })
                });
            };
...
//Many LiteScript operators can be easily mapped one-to-one with their JavaScript equivalents.
    ...
    any Producer_c_operTranslate(DEFAULT_ARGUMENTS){
      ...
      return (_anyToBool(__or28=METHOD(tryGetProperty_,Producer_c_OPER_TRANSLATION)(Producer_c_OPER_TRANSLATION,1,(any_arr){name
      }))? __or28 : name);
    return undefined;
    }
//---------------------------------
...
//#### helper method assignIfUndefined(name,expression) 
     any ASTBase_assignIfUndefined(DEFAULT_ARGUMENTS){
          ...
          METHOD(out_,this)(this,6,(any_arr){any_LTR("_default(&")
, name
, any_LTR(",")
, expression
, any_LTR(");")
