...
//Create a 'Project' to hold the main module and dependant modules
        ...
        var project = new(Project,2,(any_arr){mainModule
, options
        });
        //project.compile
...
//		default filename = 'unnamed'
        ...
        var project = new(Project,2,(any_arr){filename
, options
        });
...
, sourceLines
        ...
        __call(set_,PROP(moduleCache_,project),2,(any_arr){filename
, moduleNode
        });
//import dependencies
...
void Compiler__moduleInit(void){
    ...
    Compiler_buildDate = any_LTR("2014-07-29T21:05:48.266Z");
};
