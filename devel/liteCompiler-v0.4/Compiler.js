...
//2. each VariableDecl, from ImportStatements
    ...
    Project.prototype.produceModule = function(moduleNode){
       ...
       var firstLine = this.options.extraComments ? "//Compiled by LiteScript compiler v" + (version) + ", source: " + (moduleNode.fileInfo.filename) : "";

       //moduleNode.produce firstLine, .options.extraComments
       moduleNode.produce(firstLine, this.options.extraComments);
    };
...
//            extensions
   ...
   exports.registerRequireExtensions=registerRequireExtensions;
...
//        #declare item:Grammar.Identifier
       ...
       for( var item__inx=0,item=undefined; item__inx<exportedArr.length; item__inx++){item=exportedArr[item__inx];
