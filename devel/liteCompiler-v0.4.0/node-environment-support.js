...
//we search the module
       ...
       if (!this.extension || this.extension === '.md') {
           ...
           var list__1=['.lite.md', '.lite', '.js'];
           for( var ext__inx=0,ext=undefined; ext__inx<list__1.length; ext__inx++){ext=list__1[ext__inx];
...
//            declare on statInterface mtime
   ...
   //public helper function setBasePath(filename, options)
...
//            basePath,outBasePath,mainModuleName,outDir
   ...
   //public helper public function relName(filename,basePath)
