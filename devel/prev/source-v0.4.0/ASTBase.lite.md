...
try parse
            ...
            var statement = .opt(directASTNode)
...
check for excesive indent
                  ...
                  .lexer.softError = new Error("#{.lexer.posToString()} indent decreased: close block indent #{blockIndent} started at line #{startLine}")
                  break #end of list
...
out as comment
        ...
        .outCode.lastOutCommentLine = lineInx
...
#### helper method outLinesAsComment(fromLine,toLine)
        ...
        .outCode.currLine="" #clear indents
