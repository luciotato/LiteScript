...
### export helper class ForWhereFilter extends ASTBase
...
### public class PropertyAccess extends Accessor
...
### public class ImportStatementItem extends ASTBase
...
### export helper class SwitchCase extends ASTBase
...
### export helper class CaseWhenSection extends ASTBase
Helper class to parse each case
...
(It is not in StatementsDirect because starts wih 'do' as DoLoopStatement)
            ...
            .statement = .opt(DoNothingStatement)
            if no .statement
