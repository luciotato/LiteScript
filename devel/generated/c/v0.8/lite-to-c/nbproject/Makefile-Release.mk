...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lite-to-c

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lite-to-c: include/libgc.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lite-to-c: ${OBJECTFILES}
...
${OBJECTDIR}/generated/c_lite.o: generated/c_lite.c 
	${MKDIR} -p ${OBJECTDIR}/generated
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DNDEBUG -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/generated/c_lite.o generated/c_lite.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lite-to-c
