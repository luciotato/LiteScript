...
//--------------
    ...
    //auto OptionsParser_newFromObject
    inline any OptionsParser_newFromObject(DEFAULT_ARGUMENTS){
        return _newFromObject(OptionsParser,argc,arguments);
    }
...
//#### constructor(argv:array)
     void OptionsParser__init(DEFAULT_ARGUMENTS){
        ...
        PROP(items_,this) = METHOD(slice_,argv)(argv,1,(any_arr){any_number(1)}); //remove this script/exe 'lite' from command line arguments
     }
