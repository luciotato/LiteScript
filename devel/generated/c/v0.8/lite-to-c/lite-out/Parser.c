...
any Parser_pushAt(DEFAULT_ARGUMENTS); //forward declare
    ...
    static _posTableItem_t Parser_SourceMapMark_PROPS[] = {
    col_
    , lin_
    };
            ...
            if (_anyToNumber((indent=METHOD(countSpaces_,line)(line,0,NULL))) >= 0)  {
                ...
                if (__is(METHOD(charAt_,line)(line,1,(any_arr){any_number(0)}),any_str("#")) && !__is(METHOD(charAt_,line)(line,1,(any_arr){any_number(1)}),any_str("#")))  { //expected: "#else, #endif #end if"
                    ...
                    //case words.tryGet(0)
                        ...
                        //when '#else'
                    if (__is(METHOD(tryGet_,words)(words,1,(any_arr){any_number(0)}),any_str("#else"))){
                        ...
                        //when "#end"
                    else if (__is(METHOD(tryGet_,words)(words,1,(any_arr){any_number(0)}),any_str("#end"))){
                        ...
                        //when "#endif"
                    else if (__is(METHOD(tryGet_,words)(words,1,(any_arr){any_number(0)}),any_str("#endif"))){
                            //endFound = true
                            endFound = true;
                ...
                //else
                    ...
                    if (!(_anyToBool(defValue)) && _anyToBool(line)) {METHOD(replaceSourceLine_,this)(this,1,(any_arr){_concatAny(3,String_spaces(undefined,1,(any_arr){indent}), any_str("//"), line)});};
                };
                //end if
...
//`lexer options literal (map|object)`
        ...
        if (__is(METHOD(tryGet_,words)(words,1,(any_arr){any_number(0)}),any_str("lexer")) && __is(METHOD(tryGet_,words)(words,1,(any_arr){any_number(1)}),any_str("options")))  {
            ...
            //else if words.slice(2,5).join(" ") is "object literal is" 
            ...
            else if (__is(__call(join_,METHOD(slice_,words)(words,2,(any_arr){any_number(2), any_number(5)}),1,(any_arr){any_str(" ")}),any_str("object literal is")))  {
                ...
                if (!(_anyToBool((PROP(literalMap_,PROP(options_,lexer))=METHOD(tryGet_,words)(words,1,(any_arr){any_number(5)})))))  {
                    ...
                    throw(new(Error,1,(any_arr){any_str("missing class to be used instead of object literals")}));;// #check
                };
            }
...
//a IDENTIFIER starts with A-Z a-z (a unicode codepoint), $ or _
            ...
            if (_anyToBool((wordLetters=PMREX_whileRanges(undefined,3,(any_arr){chunk, any_number(0), any_str("A-Za-z\x7F-\xFF$_")}))))  {
                ...
                if (CALL1(indexOf_,any_str("|is|isnt|not|and|but|into|like|or|in|into|instance|instanceof|has|hasnt|bitand|bitor|"),_concatAny(3,any_str("|"), METHOD(slice_,chunk)(chunk,2,(any_arr){any_number(0), wordLetters}), any_str("|"))).value.number>=0)  {
...
void Parser__moduleInit(void){
        ...
        Parser_SourceMapMark =_newClass("Parser_SourceMapMark", Parser_SourceMapMark__init, sizeof(struct Parser_SourceMapMark_s), Object.value.classINFOptr);
