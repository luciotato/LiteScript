...
//--------------
    ...
    extern any Parser_Lexer_newFromObject(DEFAULT_ARGUMENTS);
...
//--------------
    ...
    extern any Parser_Token_newFromObject(DEFAULT_ARGUMENTS);
...
//--------------
    ...
    extern any Parser_InfoLine_newFromObject(DEFAULT_ARGUMENTS);
...
//--------------
    ...
    extern any Parser_LexerPos_newFromObject(DEFAULT_ARGUMENTS);
...
//--------------
    ...
    extern any Parser_MultilineSection_newFromObject(DEFAULT_ARGUMENTS);
    //-------------------------
...
//--------------
    ...
    extern any Parser_OutCode_newFromObject(DEFAULT_ARGUMENTS);
...
//--------------
    ...
    extern any Parser_DynBuffer_newFromObject(DEFAULT_ARGUMENTS);
...
//--------------
    ...
    typedef struct Parser_SourceMapMark_s * Parser_SourceMapMark_ptr;
    typedef struct Parser_SourceMapMark_s {
        //SourceMapMark
        any col;
        any lin;
    
    } Parser_SourceMapMark_s;
    
    extern void Parser_SourceMapMark__init(DEFAULT_ARGUMENTS);
    extern any Parser_SourceMapMark_newFromObject(DEFAULT_ARGUMENTS);
#endif
