//Compiled by LiteScript compiler v0.7.9, source: /home/ltato/LiteScript/devel/source/v0.8/Parser.lite.md
// The Parser Module
// =================
...
// with a call to core function "concat"
                ...
                //else //-> JavaScript
                   ...
                   if (parsed.length && "\"\'".indexOf(parsed[0][0])===-1) { // if it do not start with quotes
