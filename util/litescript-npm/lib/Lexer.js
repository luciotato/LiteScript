...
//clear out helper
         ...
         this.out = new OutCode();// #helper class
          //declare valid .compiler.activeOptions
         this.out.start(this.compiler.activeOptions);
...
//compile the body
           ...
           var moduleNode = this.compiler.compileModule(referenceName, bodyLines, {browser: this.compiler.activeOptions.browser, target: 'js', verbose: 0, skip: true});
...
//Compiled by LiteScript compiler v0.5.0, source: /home/ltato/LiteScript/source-v0.6.0/Lexer.lite.md
