//Compiled by LiteScript compiler v0.7.0, source: /home/ltato/LiteScript/devel/source-v0.7/log.lite.md
   ...
   function debug(){
       if (options.debug.enabled) {
           var args = Array.prototype.slice.apply(Array.prototype.slice.call(arguments));
   ...
   function message(){
       ...
       if (options.verbose >= 1) {
           if (options.storeMessages) {
               messages.push(Array.prototype.join.call(Array.prototype.slice.call(arguments), " "));
           }
           else {
   ...
   function throwControled(){
       var e = new Error(Array.prototype.slice.apply(Array.prototype.slice.call(arguments)).join(" "));
       e.controled = true;
