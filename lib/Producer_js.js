//Generated by LiteScript compiler v0.8.7, source: Producer_js.lite.md
// -----------
// Module Init
// -----------
//===========
...
//add end of file comments
        ...
        //.outSourceLinesAsComment .endSourceLineNum+1
        this.outSourceLinesAsComment(this.endSourceLineNum + 1);
...
//close the function, add source map for function default "return undefined" execution point
      ...
      if (this.lexer.outCode.sourceMap) {
          ...
          this.lexer.outCode.sourceMap.add(this.body.endSourceLineNum + 1, 0, this.lexer.outCode.lineNum - 1, 0);
      };
     };
      //endif
